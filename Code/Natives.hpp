...
// Generated 22 Sep 2021


namespace PLAYER
{
	inline Player* GET_PLAYER_PED(Player* player) { return invoke<Player*>(0x43A66C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	...
	inline void SET_PLAYER_MODEL(Player player, Hash modelHash) { invoke<Void>(0x00A1CADD00108836, player, modelHash); } // 0x00A1CADD00108836 0x774A4C54
	inline void CHANGE_PLAYER_PED(Player player, Ped ped, BOOL p, BOOL resetDamage) { invoke<Void>(0x048189FAC643DEEE, player, ped, p, resetDamage); } // 0x048189FAC643DEEE 0xBE515485
	...
	inline void SET_PLAYER_WANTED_CENTRE_POSITION(Player player, float x, float y, float z) { invoke<Void>(0x520E541A97A13354, player, x, y, z); } // 0x520E541A97A13354 0xF261633A
	...
	inline BOOL IS_PLAYER_PRESSING_HORN(Vehicle player) { return invoke<BOOL>(0xFA1E2BF8B10598F9, player); } // 0xFA1E2BF8B10598F9 0xED1D1662
	inline void SET_PLAYER_CONTROL(Player player, BOOL toggle, int flags) { invoke<Void>(0x8D32347D6D4C40A2, player, toggle, flags); } // 0x8D32347D6D4C40A2 0xD17AFCD8
	...
	inline void SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(Blip player) { invoke<Void>(0x471D2FF42A94B4F2, player); } // 0x471D2FF42A94B4F2 0xBF974891
	...
	inline void SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS(Player player, Hash* toggle) { invoke<Void>(0x596976B02B6B5700, player, toggle); } // 0x596976B02B6B5700 0xA3D675ED
	...
	inline void AI_PHONE_ARGS(Player player) { invoke<Void>(0xBC9490CA15AEA8FB, player); } // 0xBC9490CA15AEA8FB 0x6B34A160
	...
	inline int GET_PLAYER_MAX_ARMOUR(Any vector) { return invoke<int>(0x92659B4CE1863CB3, vector); } // 0x92659B4CE1863CB3 0x02A50657
	...
	inline Player IS_PLAYER_FREE_FOR_AMBIENT_TASK(Player player) { return invoke<Player>(0xDCCFD3F106C36AB4, player); } // 0xDCCFD3F106C36AB4 0x85C7E232
	...
	inline Player NETWORK_PLAYER_ID_TO_INT() { return invoke<Player>(0xEE68096F9F37341E); } // 0xEE68096F9F37341E 0x8DD5B838
	...
	inline void FORCE_CLEANUP(Object* cleanupFlags) { invoke<Void>(0xBC8983F38F78ED51, cleanupFlags); } // 0xBC8983F38F78ED51 0xFDAAEA2B
	...
	inline Pickup GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() { return invoke<Pickup>(0x9A41CF4674A12272); } // 0x9A41CF4674A12272 0x39AA9FC8
	...
	inline const char* GIVE_ACHIEVEMENT_TO_PLAYER(Hash achievement) { return invoke<const char*>(0xBEC7076D64130195, achievement); } // 0xBEC7076D64130195 0x822BC992
	inline BOOL _SET_ACHIEVEMENT_PROGRESSION(int achId, int progression) { return invoke<BOOL>(0xC2AFFFDABBDC2C5C, achId, progression); } // 0xC2AFFFDABBDC2C5C
	inline Any* _GET_ACHIEVEMENT_PROGRESSION(Vehicle achId) { return invoke<Any*>(0x1C186837D0619335, achId); } // 0x1C186837D0619335
	inline Any* HAS_ACHIEVEMENT_BEEN_PASSED(Vehicle* achievement) { return invoke<Any*>(0x867365E111A3B6EB, achievement); } // 0x867365E111A3B6EB 0x136A5BE9
	...
	inline void DISPLAY_SYSTEM_SIGNIN_UI(Blip* unk) { invoke<Void>(0x94DD7888C10A979E, unk); } // 0x94DD7888C10A979E 0x4264CED2
	...
	inline void SET_PLAYER_TARGETING_MODE(Blip targetMode) { invoke<Void>(0xB1906895227793F3, targetMode); } // 0xB1906895227793F3 0x61CAE253
	inline void _0x5702B917B99DB1CD(BOOL* p0) { invoke<Void>(0x5702B917B99DB1CD, p0); } // 0x5702B917B99DB1CD
	inline BOOL _0xB9CF1F793A9F1BF1() { return invoke<BOOL>(0xB9CF1F793A9F1BF1); } // 0xB9CF1F793A9F1BF1
	inline void CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(Vehicle* player) { invoke<Void>(0xF0B67A4DE6AB5F98, player); } // 0xF0B67A4DE6AB5F98 0x1D31CBBD
	...
	inline void SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(Ped* player, Vehicle multiplier) { invoke<Void>(0xCA7DC8329F0A1E9E, player, multiplier); } // 0xCA7DC8329F0A1E9E 0xF20F72E5
	inline void SET_SWIM_MULTIPLIER_FOR_PLAYER(Ped player, float multiplier) { invoke<Void>(0xA91C6F0FF7D16A13, player, multiplier); } // 0xA91C6F0FF7D16A13 0xB986FF47
	...
	inline int GET_TIME_SINCE_LAST_DEATH() { return invoke<Pickup>(0xC7034807558DDFCA); } // 0xC7034807558DDFCA 0x24BC5AC0
	...
	inline void _DISABLE_PLAYER_SOMETHING() { invoke<Void>(0xB885852C39CC265D); } // 0xB885852C39CC265D
	...
	inline void _SPECIAL_ABILITY_CHARGE_ON_MISSION_FAILED(Player player) { invoke<Void>(0xC9A763D8FE87436A, player); } // 0xC9A763D8FE87436A 0x4136829A
	...
	inline void SPECIAL_ABILITY_CHARGE_MEDIUM(Player player, Vehicle p1, Vehicle p2) { invoke<Void>(0xF113E3AA9BC54613, player, p1, p2); } // 0xF113E3AA9BC54613 0xAB55D8F3
	inline void SPECIAL_ABILITY_CHARGE_LARGE(Player player, int p1, Hash p2) { invoke<Void>(0xF733F45FA4497D93, player, p1, p2); } // 0xF733F45FA4497D93 0xF440C04D
	...
	inline BOOL IS_SPECIAL_ABILITY_ACTIVE(Ped player) { return invoke<BOOL>(0x3E5F7FC85D854E15, player); } // 0x3E5F7FC85D854E15 0x1B17E334
	...
	inline BOOL _IS_PLAYER_WITHIN_TEST_CAPSULE(Player player, float p1) { return invoke<BOOL>(0xDD2620B7B9D16FF1, player, p1); } // 0xDD2620B7B9D16FF1 0x8CB53C9F
	inline void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL keepVehicle, BOOL keepVelocity, BOOL fadeInOut) { invoke<Void>(0xAD15F075A4DA0FDE, player, x, y, z, heading, keepVehicle, keepVelocity, fadeInOut); } // 0xAD15F075A4DA0FDE 0xC552E06C
	...
	inline void SET_PLAYER_WEAPON_DAMAGE_MODIFIER(Player player, Pickup* damageAmount) { invoke<Void>(0xCE07B9F7817AADA3, player, damageAmount); } // 0xCE07B9F7817AADA3 0xB02C2F39
	...
	inline void SET_PLAYER_PARACHUTE_TINT_INDEX(Ped ped, Vehicle* vehicleindex) { invoke<Void>(0xA3D0E54541D9A5E5, ped, vehicleindex); } // 0xA3D0E54541D9A5E5 0x8EA12EDB
	...
	inline Any* GET_PLAYER_HAS_RESERVE_PARACHUTE(Any player) { return invoke<Any*>(0x5DDFE2FF727F3CA3, player); } // 0x5DDFE2FF727F3CA3 0x30DA1DA1
	...
	inline void SIMULATE_PLAYER_INPUT_GAIT(Player control, float amount, int gaitType, float speed, BOOL p4, BOOL p5) { invoke<Void>(0x477D5D63E63ECA5D, control, amount, gaitType, speed, p4, p5); } // 0x477D5D63E63ECA5D 0x0D77CC34
	inline void RESET_PLAYER_INPUT_GAIT(Pickup player) { invoke<Void>(0x19531C47A2ABD691, player); } // 0x19531C47A2ABD691 0x4A701EE1
	...
	inline Any* _0x690A61A6D13583F6(Player p0) { return invoke<Any*>(0x690A61A6D13583F6, p0); } // 0x690A61A6D13583F6 0x1D371529
	...
	inline Any* HAS_PLAYER_BEEN_SPOTTED_IN_STOLEN_VEHICLE(Ped* player) { return invoke<Any*>(0xD705740BB0A1CF4C, player); } // 0xD705740BB0A1CF4C 0x4A01B76A
	inline Any* _0x38D28DA81E4E9BF9(ScrHandle player) { return invoke<Any*>(0x38D28DA81E4E9BF9, player); } // 0x38D28DA81E4E9BF9 0x013B4F72
	...
	inline Any* IS_PLAYER_RIDING_TRAIN(Vehicle* player) { return invoke<Any*>(0x4EC12697209F2196, player); } // 0x4EC12697209F2196 0x9765E71D
	inline Any* HAS_PLAYER_LEFT_THE_WORLD(Ped* player) { return invoke<Any*>(0xD55DDFB47991A294, player); } // 0xD55DDFB47991A294 0xFEA40B6C
	...
	inline Any* _0x65FAEE425DE637B0(BOOL player) { return invoke<Any*>(0x65FAEE425DE637B0, player); } // 0x65FAEE425DE637B0
	inline void _SET_UNK_FRAMEFLAG(Vehicle* player) { invoke<Void>(0x5501B7A5CDB79D37, player); } // 0x5501B7A5CDB79D37
	inline Any _0x56105E599CAB0EFA(Ped p7) { return invoke<Any>(0x56105E599CAB0EFA, p7); } // 0x56105E599CAB0EFA
}

namespace ENTITY
{
	inline BOOL DOES_ENTITY_EXIST(Entity entity) { return invoke<BOOL>(0x7239B21A38F536BA, entity); } // 0x7239B21A38F536BA 0x3AC90869
	inline BOOL DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Entity entity, BOOL p2) { return invoke<BOOL>(0xDDE6DF5AE89981D2, entity, p2); } // 0xDDE6DF5AE89981D2 0xACFEB3F9
	...
	inline float _GET_ANIM_DURATION(const char* animDict, const char* animName) { return invoke<float>(0xFEDDF04D62B8D790, animDict, animName); } // 0xFEDDF04D62B8D790
	...
	inline BOOL IS_ENTITY_AN_OBJECT(Player* entity) { return invoke<BOOL>(0x8D68C8FD0FACA94E, entity); } // 0x8D68C8FD0FACA94E 0x3F52E561
	...
	inline void _SET_USED_BY_PLAYER(Entity entity, BOOL toggle) { invoke<Void>(0x694E00132F2823ED, entity, toggle); } // 0x694E00132F2823ED 0x40C84A74
	inline BOOL IS_ENTITY_ON_SCREEN(Entity entity) { return invoke<BOOL>(0xE659E47AF827484B, entity); } // 0xE659E47AF827484B 0xC1FEC5ED
	inline BOOL IS_ENTITY_PLAYING_ANIM(Entity entity, const char* animDict, const char* animName, int taskFlag) { return invoke<BOOL>(0x1F0B79228E461EC9, entity, animDict, animName, taskFlag); } // 0x1F0B79228E461EC9 0x0D130D34
	inline BOOL IS_ENTITY_inline(Entity entity) { return invoke<BOOL>(0x1218E6886D3D8327, entity); } // 0x1218E6886D3D8327 0x928E12E9
	...
	inline void _SET_ENTITY_NOT_HAVE_ADVANCED_PHYSICS(Entity entity, BOOL toggle) { invoke<Void>(0x3910051CCECDB00C, entity, toggle); } // 0x3910051CCECDB00C 0xD3850671
	...
	inline BOOL PLAY_SYNCHRONIZED_ENTITY_ANIM(Entity entity, int SceneID, const char* animName, const char* animDict, float speed, float speedMult, int flag, float flag2) { return invoke<BOOL>(0xC77720A12FE14A86, entity, SceneID, animName, animDict, speed, speedMult, flag, flag2); } // 0xC77720A12FE14A86 0x012760AA
	inline BOOL PLAY_SYNCHRONIZED_MAP_ENTITY_ANIM(float posX, float posY, float posZ, float radius, Object prop, int sceneID, const char* animName, const char* animDict, float playbackRate, float unkFlag, BOOL unkBool, float unkFlag2) { return invoke<BOOL>(0xB9C54555ED30FBC4, posX, posY, posZ, radius, prop, sceneID, animName, animDict, playbackRate, unkFlag, unkBool, unkFlag2); } // 0xB9C54555ED30FBC4 0xEB4CBA74
	inline BOOL STOP_SYNCHRONIZED_MAP_ENTITY_ANIM(float posX, float posY, float posZ, float radius, Object object, float playbackRate) { return invoke<BOOL>(0x11E79CAB7183B6F5, posX, posY, posZ, radius, object, playbackRate); } // 0x11E79CAB7183B6F5 0x7253D5B2
	...
	inline void _SET_ENTITY_COMPLETELY_DISABLE_COLLISION(Entity entity, BOOL p1, BOOL p2) { invoke<Void>(0x9EBC85ED0FFFE51C, entity, p1, p2); } // 0x9EBC85ED0FFFE51C
	...
	inline void SET_ENTITY_ONLY_DAMAGED_BY_RELATIONSHIP_GROUP(Entity entity, BOOL p1, Hash relationshipHash) { invoke<Void>(0x7022BD828FA0B082, entity, p1, relationshipHash); } // 0x7022BD828FA0B082 0x202237E2
	inline void SET_ENTITY_PROOFS(Entity entity, BOOL bulletProof, BOOL fireProof, BOOL explosionProof, BOOL collisionProof, BOOL meleeProof, BOOL steamProof, BOOL smokeProof, BOOL drownProof) { invoke<Void>(0xFAEE099C6F890BB8, entity, bulletProof, fireProof, explosionProof, collisionProof, meleeProof, steamProof, smokeProof, drownProof); } // 0xFAEE099C6F890BB8 0x7E9EAB66
	...
	inline void SET_ENTITY_ALPHA(Entity entity, int alphaLevel, BOOL unk) { invoke<Void>(0x44A0870B7E92D7C0, entity, alphaLevel, unk); } // 0x44A0870B7E92D7C0 0xAE667CB0
	...
	inline void REMOVE_MODEL_HIDE(float x, float y, float z, float radius, Hash model, BOOL p5) { invoke<Void>(0xD9E3006FB3CBD765, x, y, z, radius, model, p5); } // 0xD9E3006FB3CBD765 0x993DBC10
	...
	inline void REMOVE_FORCED_OBJECT(float posX, float posY, float posZ, float unk, Hash modelHash) { invoke<Void>(0x61B6775E83C0DB6F, posX, posY, posZ, unk, modelHash); } // 0x61B6775E83C0DB6F 0xAED73ADD
...
namespace PED
{
	inline Ped CREATE_PED(int pedType, Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0xD49F9B0955C367DE, pedType, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); } // 0xD49F9B0955C367DE 0x0389EF71
	inline void DELETE_PED(Ped* ped) { invoke<Void>(0x9614299DCB53E54B, ped); } // 0x9614299DCB53E54B 0x13EFB9A0
	inline Ped CLONE_PED(Ped ped, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0xEF29A16337FACADB, ped, heading, isNetwork, thisScriptCheck); } // 0xEF29A16337FACADB 0x8C8A8D6E
	...
	inline Ped CREATE_PED_INSIDE_VEHICLE(Ped vehicle, int pedType, Hash modelHash, int seat, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0x7DD959874C1FD534, vehicle, pedType, modelHash, seat, isNetwork, thisScriptCheck); } // 0x7DD959874C1FD534 0x3000F092
	...
	inline void _FAIL_MISSION(BOOL toggle) { invoke<Void>(0xF2BEBCDFAFDAA19E, toggle); } // 0xF2BEBCDFAFDAA19E 0x6CD58238
	...
	inline void _SET_PED_SHOOTING_RATE(Ped ped, float unk) { invoke<Void>(0xEC4B4B3B9908052A, ped, unk); } // 0xEC4B4B3B9908052A 0xF30658D2
	...
	inline void SET_PED_MIN_GROUND_TIME_FOR_STUNGUN(Ped ped, int ms1000000) { invoke<Void>(0xFA0675AB151073FA, ped, ms1000000); } // 0xFA0675AB151073FA 0x2F0D0973
	...
	inline Any SET_PED_PINNED_DOWN(Ped player, BOOL pinned, int p2) { return invoke<Any>(0xAAD6D1ACF08F4612, player, pinned, p2); } // 0xAAD6D1ACF08F4612 0xCC78999D
	...
	inline BOOL _IS_ENEMY_IN_RANGE(Ped ped, float x, float y, float z, float range) { return invoke<BOOL>(0x336B3D200AB007CB, ped, x, y, z, range); } // 0x336B3D200AB007CB 0xFB18CB19
	...
	inline void RESET_GROUP_FORMATION_DEFAULT_SPACING(int groupId) { invoke<Void>(0x63DAB4CCB3273205, groupId); } // 0x63DAB4CCB3273205 0x267FCEAD
	...
	inline void APPLY_DAMAGE_TO_PED(Ped ped, int damageAmount, BOOL armorFirst) { invoke<Void>(0x697157CED63F18D4, ped, damageAmount, armorFirst); } // 0x697157CED63F18D4 0x4DC27FCF
	...
	inline void SET_PED_AS_COP(Ped ped, BOOL True) { invoke<Void>(0xBB03C38DD3FB7FFD, ped, True); } // 0xBB03C38DD3FB7FFD 0x84E7DE9F
	...
	inline void SET_PED_MOVEMENT_CLIPSET(BOOL player, BOOL clipSet, float blendTime) { invoke<Void>(0xAF8A94EDE7712BEF, player, clipSet, blendTime); } // 0xAF8A94EDE7712BEF 0xA817CDEB
	...
	inline void _SET_PED_COVER_CLIPSET_OVERRIDE(Ped ped, const char* clipset) { invoke<Void>(0x9DBA107B4937F809, ped, clipset); } // 0x9DBA107B4937F809
	inline void _CLEAR_PED_COVER_CLIPSET_OVERRIDE(Ped ped) { invoke<Void>(0xC79196DCB36F6121, ped); } // 0xC79196DCB36F6121
	...
	inline int GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(Ped SC, int sc) { return invoke<int>(0x27561561732A7842, SC, sc); } // 0x27561561732A7842 0x9754C27D
	...
	inline int GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(Ped mp_f_freemode_01, int ComponentID, int DrawableID) { return invoke<int>(0x8F7156A3142A6BAD, mp_f_freemode_01, ComponentID, DrawableID); } // 0x8F7156A3142A6BAD 0x83D9FBE7
	...
	inline void SET_PED_BLEND_FROM_PARENTS(Ped ped, Ped father, Ped mother, float fathersSide, float mothersSide) { invoke<Void>(0x137BBD05230DB22D, ped, father, mother, fathersSide, mothersSide); } // 0x137BBD05230DB22D 0x837BD370
	...
	inline void _GET_HAIR_COLOR(int colorID, int* R, int* G, int* B) { invoke<Void>(0x4852FC386E2E1BB5, colorID, R, G, B); } // 0x4852FC386E2E1BB5
	inline void _GET_LIPSTICK_COLOR(int colorID, int* R, int* G, Any* B) { invoke<Void>(0x013E5CFC38CD5387, colorID, R, G, B); } // 0x013E5CFC38CD5387
	inline BOOL _0xED6D8E27A43B8CDE(int ColorID) { return invoke<BOOL>(0xED6D8E27A43B8CDE, ColorID); } // 0xED6D8E27A43B8CDE
	...
	inline Any _0xC56FBF2F228E1DAC(Hash modelHash, Any p1, Any p2) { return invoke<Any>(0xC56FBF2F228E1DAC, modelHash, p1, p2); } // 0xC56FBF2F228E1DAC
	...
	inline void _0xA21C118553BBDF02(Ped ped) { invoke<Void>(0xA21C118553BBDF02, ped); } // 0xA21C118553BBDF02 0xC6F36292
	...
	inline Any _0x39D55A620FCB6A3A(Ped ped, int slot, int drawableId, int textureId) { return invoke<Any>(0x39D55A620FCB6A3A, ped, slot, drawableId, textureId); } // 0x39D55A620FCB6A3A 0x45F3BDFB
	inline BOOL _ARE_COMPONENTS_LOADED(Ped p0) { return invoke<BOOL>(0x66680A92700F43DF, p0); } // 0x66680A92700F43DF 0xC6517D52
	...
	inline BOOL _IS_PED_GETTING_ON_BIKE(Ped ped) { return invoke<BOOL>(0x784002A632822099, ped); } // 0x784002A632822099 0x3B0CA391
	...
	inline void SET_PED_PROP_INDEX(Ped ped, int componentId, int drawableId, int TextureId, BOOL isNetworkGame) { invoke<Void>(0x93376B65A266EB5F, ped, componentId, drawableId, TextureId, isNetworkGame); } // 0x93376B65A266EB5F 0x0829F2E2
	inline void KNOCK_OFF_PED_PROP(Ped ped, BOOL p1, BOOL knockOff, BOOL p2, BOOL p3) { invoke<Void>(0x6FD7816A36615F48, ped, p1, knockOff, p2, p3); } // 0x6FD7816A36615F48 0x08D8B180
	...
	inline void SET_DRIVER_RACING_MODIFIER(Ped driver, float racingModifier) { invoke<Void>(0xDED5AF5A0EA4B297, driver, racingModifier); } // 0xDED5AF5A0EA4B297 0x6D55B3B3
	...
	inline void APPLY_PED_BLOOD_SPECIFIC(Ped ped, Any p1, float xOffset, float yOffset, float zOffset, float scale, Any p6, float p7, const char* bloodType) { invoke<Void>(0xEF0D582CBF2D9B0F, ped, p1, xOffset, yOffset, zOffset, scale, p6, p7, bloodType); } // 0xEF0D582CBF2D9B0F 0xFC13CE80
	inline void APPLY_PED_DAMAGE_DECAL(Ped ped, int damageZone, float xOffset, float yOffset, float zOffset, float scale, float alpha, int variation, BOOL fadeIn, const char* decalName) { invoke<Void>(0x397C38AA7B4A5F83, ped, damageZone, xOffset, yOffset, zOffset, scale, alpha, variation, fadeIn, decalName); } // 0x397C38AA7B4A5F83 0x8A13A41F
	...
	inline BOOL GET_PED_DECORATIONS_STATE(Ped ped) { return invoke<BOOL>(0x71EAB450D86954A1, ped); } // 0x71EAB450D86954A1 0x47187F7F
	...
	inline void _CLEAR_PED_SOMETHING(Ped ped) { invoke<Void>(0x6585D955A68452A5, ped); } // 0x6585D955A68452A5 0xA993915F
	...
	inline int ADD_SCENARIO_BLOCKING_AREA(float x1, float y1, float z1, float x2, float y2, float z2, BOOL p6, BOOL p7, BOOL p8, BOOL p9) { return invoke<int>(0x1B5C85C612E5256E, x1, y1, z1, x2, y2, z2, p6, p7, p8, p9); } // 0x1B5C85C612E5256E 0xA38C0234
	inline void REMOVE_SCENARIO_BLOCKING_AREAS() { invoke<Void>(0xD37401D78A929A49); } // 0xD37401D78A929A49 0x4DDF845F
	inline void REMOVE_SCENARIO_BLOCKING_AREA(int areaHandle, BOOL p1) { invoke<Void>(0x31D16B74C6E29D66, areaHandle, p1); } // 0x31D16B74C6E29D66 0x4483EF06
	inline void SET_SCENARIO_PEDS_SPAWN_IN_SPHERE_AREA(float x, float y, float z, float range, int p4) { invoke<Void>(0x28157D43CF600981, x, y, z, range, p4); } // 0x28157D43CF600981 0x80EAD297
	...
	inline void _SET_PED_CAN_PLAY_INJURED_ANIMS(Ped ped, BOOL p1) { invoke<Void>(0x33A60D8BDD6E508C, ped, p1); } // 0x33A60D8BDD6E508C 0xADB2511A
	...
	inline void SET_PED_RESET_FLAG(Ped ped, int flagId, BOOL value) { invoke<Void>(0xC1E8A365BF3B29F2, ped, flagId, value); } // 0xC1E8A365BF3B29F2 0xCFF6FF66
	...
	inline BOOL _0x451294E859ECC018(int p0) { return invoke<BOOL>(0x451294E859ECC018, p0); } // 0x451294E859ECC018 0x8A3A3116
	...
	inline void SET_PED_CAN_PEEK_IN_COVER(Ped player, BOOL aim) { invoke<Void>(0xC514825C507E3736, player, aim); } // 0xC514825C507E3736 0xC1DAE216
	...
	inline void SET_PED_COMBAT_ABILITY(Ped ped, int ability) { invoke<Void>(0xC7622C0D36B2FDA8, ped, ability); } // 0xC7622C0D36B2FDA8 0x6C23D329
	...
	inline void _SET_PED_FAST_ANIMATIONS(Ped ped, BOOL p1, BOOL p2) { invoke<Void>(0x2208438012482A1A, ped, p1, p2); } // 0x2208438012482A1A 0x187B9070
	...
	inline void _TRACK_PED_VISIBILITY(Ped ped) { invoke<Void>(0x7D7A2E43E74E2EB8, ped); } // 0x7D7A2E43E74E2EB8 0x840D24D3
	...
	inline BOOL HAS_PED_RECEIVED_EVENT(Ped ped, Any p1) { return invoke<BOOL>(0x8507BCB710FA6DC0, ped, p1); } // 0x8507BCB710FA6DC0 0xECD73DB0
	...
	inline void _0x2B5AA717A181FB4C(Ped ped, BOOL p1) { invoke<Void>(0x2B5AA717A181FB4C, ped, p1); } // 0x2B5AA717A181FB4C 0x98E29ED0
	inline BOOL _0xB8B52E498014F5B0(Ped ped) { return invoke<BOOL>(0xB8B52E498014F5B0, ped); } // 0xB8B52E498014F5B0
	inline int CREATE_SYNCHRONIZED_SCENE(float posX, float posY, float posZ, float roll, float pitch, float yaw, int p6) { return invoke<int>(0x8C18E0F9080ADD73, posX, posY, posZ, roll, pitch, yaw, p6); } // 0x8C18E0F9080ADD73 0xFFDDF8FA
	...
	inline void SET_SYNCHRONIZED_SCENE_ORIGIN(int sceneID, float x, float y, float z, float roll, float pitch, float yaw, int unk) { invoke<Void>(0x6ACF6B7225801CD7, sceneID, x, y, z, roll, pitch, yaw, unk); } // 0x6ACF6B7225801CD7 0x2EC2A0B2
	...
	inline void _SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(int sceneID, BOOL p1) { invoke<Void>(0x394B9CD12435C981, sceneID, p1); } // 0x394B9CD12435C981 0x2DE48DA1
	inline BOOL _0x7F2F4F13AC5257EF(int SceneID) { return invoke<BOOL>(0x7F2F4F13AC5257EF, SceneID); } // 0x7F2F4F13AC5257EF 0x72CF2514
	...
	inline BOOL _0xF60165E1D2C5370B(Ped ped, Any* p1, float* p2) { return invoke<BOOL>(0xF60165E1D2C5370B, ped, p1, p2); } // 0xF60165E1D2C5370B
	...
	inline void SET_PED_USING_ACTION_MODE(Ped ped, BOOL state, int timeout, const char* action) { invoke<Void>(0xD75ACCF5E0FB5367, ped, state, timeout, action); } // 0xD75ACCF5E0FB5367 0x8802F696
	...
	inline Any GET_QUADBIKE_DISPLAY_VARIATIONS(Any p0) { return invoke<Any>(0x953563CE563143AF, p0); } // 0x953563CE563143AF 0x4DD03628
	...
	inline BOOL _0xF0DAEF2F545BEE25(int headshotHandle) { return invoke<BOOL>(0xF0DAEF2F545BEE25, headshotHandle); } // 0xF0DAEF2F545BEE25 0x10F2C023
	...
	inline void _SET_PED_HEATSCALE_OVERRIDE(Any p0, Any p1) { invoke<Void>(0xC1F6EBF9A3D55538, p0, p1); } // 0xC1F6EBF9A3D55538 0xEF9142DB
	...
	inline void _0xED3C76ADFA6D07C4(Ped ped) { invoke<Void>(0xED3C76ADFA6D07C4, ped); } // 0xED3C76ADFA6D07C4 0xFB4000DC
	...
	inline void _0xE861D0B05C7662B8(Pickup p0, Any p1, Blip* p2) { invoke<Void>(0xE861D0B05C7662B8, p0, p1, p2); } // 0xE861D0B05C7662B8 0x2F9550C2
...
namespace VEHICLE
{
	...
	inline int _GET_VEHICLE_WEAPON_TARGET_LOCK_STATUS(Vehicle vehicle) { return invoke<int>(0xE6B0E8CFC3633BF0, vehicle); } // 0xE6B0E8CFC3633BF0 0xFBDE9FD8
	...
	inline BOOL DOES_SCRIPT_VEHICLE_GENERATOR_EXIST(int v) { return invoke<BOOL>(0xF6086BC836400876, v); } // 0xF6086BC836400876 0xF6BDDA30
	...
	inline void SET_SCRIPT_VEHICLE_GENERATOR(int vehicleGenerator, BOOL enabled) { invoke<Void>(0xD9D620E0AC6DC4B0, vehicleGenerator, enabled); } // 0xD9D620E0AC6DC4B0 0x40D73747
	inline void SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(float minX, float minY, float minZ, float maxX, float maxY, float maxZ, BOOL p6, BOOL p7) { invoke<Void>(0xC12321827687FE4D, minX, minY, minZ, maxX, maxY, maxZ, p6, p7); } // 0xC12321827687FE4D 0xB4E0E69A
	...
	inline Any SET_ALL_VEHICLES_SPAWN(Vehicle vehicle, BOOL p1, BOOL p2, BOOL p3) { return invoke<Any>(0xE023E8AC4EF7C117, vehicle, p1, p2, p3); } // 0xE023E8AC4EF7C117 0xA0909ADB
	...
	inline void SET_DISABLE_RANDOM_TRAINS_THIS_FRAME(BOOL toggle) { invoke<Void>(0xD4B8E3D1917BC86B, toggle); } // 0xD4B8E3D1917BC86B 0x09462665
	...
	inline void SET_VEHICLE_DOORS_LOCKED(int* vehicle, float* doorLockStatus) { invoke<Void>(0xB664292EAECF7FA6, vehicle, doorLockStatus); } // 0xB664292EAECF7FA6 0x4CDD35D0
	inline void SET_PED_TARGETTABLE_VEHICLE_DESTROY(Vehicle vehicle, int doorIndex, int destroyType) { invoke<Void>(0xBE70724027F85BCD, vehicle, doorIndex, destroyType); } // 0xBE70724027F85BCD 0xD61D182D
	...
	inline void SET_VEHICLE_DOORS_LOCKED_FOR_NON_SCRIPT_PLAYERS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x9737A37136F07E75, vehicle, toggle); } // 0x9737A37136F07E75 0xE4EF6514
	...
	inline void ADD_VEHICLE_PHONE_EXPLOSIVE_DEVICE(Vehicle vehicle) { invoke<Void>(0x99AD4CCCB128CBC9, vehicle); } // 0x99AD4CCCB128CBC9 0x811373DE
	inline BOOL HAS_VEHICLE_PHONE_EXPLOSIVE_DEVICE() { return invoke<BOOL>(0x6ADAABD3068C5235); } // 0x6ADAABD3068C5235 0xA4E69134
	inline void DETONATE_VEHICLE_PHONE_EXPLOSIVE_DEVICE() { invoke<Void>(0xEF49CF0270307CBE); } // 0xEF49CF0270307CBE 0x65255524
	...
	inline void _0x8F719973E1445BA2(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x8F719973E1445BA2, vehicle, toggle); } // 0x8F719973E1445BA2 0x35614622
	...
	inline void BRING_VEHICLE_TO_HALT(Vehicle vehicle, float distance, int type, BOOL unknown) { invoke<Void>(0x260BE8F09E326A20, vehicle, distance, type, unknown); } // 0x260BE8F09E326A20 0xCBC7D3C8
	inline void _SET_VEHICLE_FORKLIFT_HEIGHT(Vehicle vehicle, float height) { invoke<Void>(0x37EBBF3117BD6A25, vehicle, height); } // 0x37EBBF3117BD6A25 0x943A6CFC
	...
	inline Vehicle _GET_VEHICLE_ATTACHED_TO_ENTITY(Vehicle object) { return invoke<Vehicle>(0x375E7FC44F21C8AB, object); } // 0x375E7FC44F21C8AB 0x70DD5E25
	...
	inline int GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(Vehicle elegy) { return invoke<int>(0xF11BC2DD9A3E7195, elegy); } // 0xF11BC2DD9A3E7195 0x499747B6
	...
	inline int GET_VEHICLE_RECORDING_ID(int p0, const char* p1) { return invoke<int>(0x21543C612379DB3C, p0, p1); } // 0x21543C612379DB3C 0x328D601D
	inline void REQUEST_VEHICLE_RECORDING(int i, const char* name) { invoke<Void>(0xAF514CABE74CBF15, i, name); } // 0xAF514CABE74CBF15 0x91AFEFD9
	...
	inline float GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(int recordingID) { return invoke<float>(0x102D125411A7B6E6, recordingID); } // 0x102D125411A7B6E6 0x7116785E
	...
	inline void _0x1F2E4E06DEA8992B(Vehicle p0, BOOL p1) { invoke<Void>(0x1F2E4E06DEA8992B, p0, p1); } // 0x1F2E4E06DEA8992B 0x01B91CD0
	inline void STOP_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle) { invoke<Void>(0x54833611C17ABDEA, vehicle); } // 0x54833611C17ABDEA 0xAE99C57C
	...
	inline BOOL IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Vehicle vehicle) { return invoke<BOOL>(0x1C8A4C2C19E68EEC, vehicle); } // 0x1C8A4C2C19E68EEC 0x61F7650D
	...
	inline int GET_CURRENT_PLAYBACK_FOR_VEHICLE(Vehicle vehicle) { return invoke<int>(0x42BC05C27A946054, vehicle); } // 0x42BC05C27A946054 0xA3F44390
	...
	inline BOOL IS_VEHICLE_DOOR_FULLY_OPEN(Vehicle v, int doorIndex) { return invoke<BOOL>(0x3E933CFF7B111C22, v, doorIndex); } // 0x3E933CFF7B111C22 0xC2385B6F
	inline void SET_VEHICLE_ENGINE_ON(Vehicle vehicle, BOOL value, BOOL instantly, BOOL noAutoTurnOn) { invoke<Void>(0x2497C4717C8B881E, vehicle, value, instantly, noAutoTurnOn); } // 0x2497C4717C8B881E 0x7FBC86F1
	...
	inline void SET_VEHICLE_DOOR_LATCHED(Vehicle vehicle, int doorIndex, BOOL forceClose, BOOL lock, BOOL p4) { invoke<Void>(0xA5A9653A8D2CAF48, vehicle, doorIndex, forceClose, lock, p4); } // 0xA5A9653A8D2CAF48 0x4EB7BBFC
	...
	inline void GET_RANDOM_VEHICLE_MODEL_IN_MEMORY(BOOL p0, int modelHash, int* p2) { invoke<Void>(0x055BF0AC0C34F4FD, p0, modelHash, p2); } // 0x055BF0AC0C34F4FD 0xE2C45631
	...
	inline BOOL IS_VEHICLE_BUMPER_BOUNCING(Vehicle vehicle, BOOL frontBumper) { return invoke<BOOL>(0x27B926779DEB502D, vehicle, frontBumper); } // 0x27B926779DEB502D 0xB3A2CC4F
	...
	inline Hash _GET_VEHICLE_SEAT_CLIPSET_HASH(Vehicle vehicle, int seat) { return invoke<Hash>(0xA01BC64DD4BFBBAC, vehicle, seat); } // 0xA01BC64DD4BFBBAC
	...
	inline void REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Ped x1, Ped y1, Ped z1, Ped x2, Ped y2, Ped z2, Vehicle unk) { invoke<Void>(0x46A1E1A299EC4BBA, x1, y1, z1, x2, y2, z2, unk); } // 0x46A1E1A299EC4BBA 0x42CC15E0
	...
	inline void SET_VEHICLE_EXTRA(Vehicle vehicle, int extraId, BOOL disable) { invoke<Void>(0x7EE3A3C5E4A40CC9, vehicle, extraId, disable); } // 0x7EE3A3C5E4A40CC9 0x642D065C
	...
	inline void SET_VEHICLE_LIVERY(Vehicle vehicle, int liveryIndex) { invoke<Void>(0x60BF608F1B8CD1B6, vehicle, liveryIndex); } // 0x60BF608F1B8CD1B6 0x7AD87059
	inline int GET_VEHICLE_LIVERY(Vehicle trailers2) { return invoke<int>(0x2BB9230590DA5E8A, trailers2); } // 0x2BB9230590DA5E8A 0xEC82A51D
	...
	inline float GET_HELI_TAIL_BOOM_HEALTH(Vehicle vehicle) { return invoke<float>(0xAC51915D27E4A5F7, vehicle); } // 0xAC51915D27E4A5F7 0x8A68388F
	...
	inline void ATTACH_VEHICLE_TO_TOW_TRUCK(Vehicle towTruck, Vehicle vehicle, int index, float hookOffsetX, float hookOffsetY, float hookOffsetZ) { invoke<Void>(0x29A16F8D621C4508, towTruck, vehicle, index, hookOffsetX, hookOffsetY, hookOffsetZ); } // 0x29A16F8D621C4508 0x8151571A
	...
	inline void SET_VEHICLE_BULLDOZER_ARM_POSITION(Vehicle vehicle, float position, BOOL p2) { invoke<Void>(0xF8EBCCC96ADB9FB7, vehicle, position, p2); } // 0xF8EBCCC96ADB9FB7 0xED23C8A3
	...
	inline void _SET_DESIRED_VERTICAL_FLIGHT_PHASE(Vehicle vehicle, float angleRatio) { invoke<Void>(0x30D779DE7C4F6DD3, vehicle, angleRatio); } // 0x30D779DE7C4F6DD3 0xA7DF64D7
	inline void _SET_VERTICAL_FLIGHT_PHASE(Vehicle vehicle, float angle) { invoke<Void>(0x9AA47FFF660CB932, vehicle, angle); } // 0x9AA47FFF660CB932 0xDD7936F5
	...
	inline void SET_VEHICLE_BRAKE_LIGHTS(Vehicle vehicle, BOOL p1) { invoke<Void>(0x92B35082E0B42F66, vehicle, p1); } // 0x92B35082E0B42F66 0x6D9BA11E
	...
	inline void _0xCAC66558B944DA67(const char* vehicle, BOOL p1) { invoke<Void>(0xCAC66558B944DA67, vehicle, p1); } // 0xCAC66558B944DA67 0x0B200CE2
	inline void SET_VEHICLE_RUDDER_BROKEN(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x09606148B6C71DEF, vehicle, toggle); } // 0x09606148B6C71DEF 0x3FAC3CD4
	...
	inline float _GET_VEHICLE_MODEL_HAND_BRAKE(Hash modelHash) { return invoke<float>(0xBFBA3BA79CFF7EBF, modelHash); } // 0xBFBA3BA79CFF7EBF 0xF3A7293F
	...
	inline float _GET_VEHICLE_MODEL_DOWN_FORCE(Hash modelHash) { return invoke<float>(0x53409B5163D5B846, modelHash); } // 0x53409B5163D5B846 0x37FBA7BC
	inline float _GET_VEHICLE_MODEL_MAX_KNOTS(Hash modelHash) { return invoke<float>(0xC6AD107DDC9054CC, modelHash); } // 0xC6AD107DDC9054CC 0x95BB67EB
	inline float _GET_VEHICLE_MODEL_MOVE_RESISTANCE(Hash modelHash) { return invoke<float>(0x5AA3F878A178C4FC, modelHash); } // 0x5AA3F878A178C4FC 0x87C5D271
	inline float _GET_VEHICLE_CLASS_MAX_SPEED(int vehicleClass) { return invoke<float>(0x00C09F246ABEDD82, vehicleClass); } // 0x00C09F246ABEDD82 0xCE67162C
	...
	inline int _ADD_SPEED_ZONE_FOR_COORD(float x, float y, float z, float radius, float speed, BOOL p5) { return invoke<int>(0x2CE544C68FB812A0, x, y, z, radius, speed, p5); } // 0x2CE544C68FB812A0 0xD6685803
	inline BOOL _REMOVE_SPEED_ZONE(int speedzone) { return invoke<BOOL>(0x1033371FC8E842A7, speedzone); } // 0x1033371FC8E842A7 0x0C0332A6
	...
	inline BOOL CAN_SHUFFLE_SEAT(Vehicle vehicle, Ped ped) { return invoke<BOOL>(0x30785D90C956BF35, vehicle, ped); } // 0x30785D90C956BF35 0xB3EB01ED
	...
	inline void GET_VEHICLE_MOD_COLOR_1(Vehicle vehicle, int* paintType, int* color, int* pearlescentColor) { invoke<Void>(0xE8D65CA700C9A693, vehicle, paintType, color, pearlescentColor); } // 0xE8D65CA700C9A693 0xE625510A
	...
	inline void MODIFY_VEHICLE_TOP_SPEED(Vehicle vehicle, float value) { invoke<Void>(0x93A3996368C94158, vehicle, value); } // 0x93A3996368C94158 0xE943B09C
	inline void _SET_VEHICLE_ST(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x1CF38D529D7441D9, vehicle, toggle); } // 0x1CF38D529D7441D9 0xDF594D8D
	...
	inline BOOL _IS_ANY_PASSENGER_RAPPELLING(Vehicle vehicle) { return invoke<BOOL>(0x291E373D483E7EE7, vehicle); } // 0x291E373D483E7EE7 0xD656E7E5
	...
	inline void _GET_BOAT_BOOM_POSITION_RATIO(Any p0, BOOL p1) { invoke<Void>(0xC1F981A6F74F0C23, p0, p1); } // 0xC1F981A6F74F0C23 0x00966934
	...
	inline void _REMOVE_VEHICLE_OWNERSHIP(Vehicle vehicle) { invoke<Void>(0xCFD778E7904C255E, vehicle); } // 0xCFD778E7904C255E 0x3FBE904F
	...
	inline void _SET_PLANE_MIN_HEIGHT_ABOVE_TERRAIN(Vehicle plane, int height) { invoke<Void>(0xB893215D8D4C015B, plane, height); } // 0xB893215D8D4C015B 0x8C4B63E2
	...
	inline void _0x4D9D109F63FEE1D4(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x4D9D109F63FEE1D4, vehicle, toggle); } // 0x4D9D109F63FEE1D4 0x900C878C
	...
	inline void _0x06582AFF74894C75(Vehicle vehicle, BOOL p1) { invoke<Void>(0x06582AFF74894C75, vehicle, p1); } // 0x06582AFF74894C75 0x50F89338
	...
	inline void _ADD_VEHICLE_SHADOW(Vehicle vehicle, int p1, int p2) { invoke<Void>(0xF0E4BA16D1DB546C, vehicle, p1, p2); } // 0xF0E4BA16D1DB546C 0x5BD8D82D
	...
	inline void _0x0CDDA42F9E360CA6(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x0CDDA42F9E360CA6, vehicle, toggle); } // 0x0CDDA42F9E360CA6 0x9B581DE7
	...
	inline void SET_PLANE_TURBULENCE_MULTIPLIER(Vehicle plane, float multiplier) { invoke<Void>(0xAD2D28A1AFDFF131, plane, multiplier); } // 0xAD2D28A1AFDFF131 0xED159AE6
	...
	inline void _DEBUG_VEHICLE(Vehicle vehicle) { invoke<Void>(0xB264C4D2F2B0A78B, vehicle); } // 0xB264C4D2F2B0A78B 0x45F72495
	...
	inline void _SET_CARGOBOB_HOOK_POSITION(Vehicle cargobob, float xOffset, float yOffset, int state) { invoke<Void>(0x877C1EAEAC531023, cargobob, xOffset, yOffset, state); } // 0x877C1EAEAC531023 0x3A8AB081
	inline void _0xCF1182F682F65307(Any p0, Player p1) { invoke<Void>(0xCF1182F682F65307, p0, p1); } // 0xCF1182F682F65307
	...
	inline void _SET_HELICOPTER_ROLL_PITCH_YAW_MULT_HEALTH(Vehicle helicopter, float multiplier) { invoke<Void>(0x6E0859B530A365CC, helicopter, multiplier); } // 0x6E0859B530A365CC 0x6E67FD35
	...
	inline void _CLEAR_VEHICLE_ROUTE_HISTORY(Vehicle vehicle) { invoke<Void>(0x6D6AF961B72728AE, vehicle); } // 0x6D6AF961B72728AE 0x8DD9AA0C
	...
	inline void SET_VEHICLE_EXCLUSIVE_DRIVER(Vehicle vehicle, Ped ped) { invoke<Void>(0x41062318F23ED854, vehicle, ped); } // 0x41062318F23ED854 0xAA8BD440
	...
	inline void SET_DISTANT_CARS_ENABLED(BOOL toggle) { invoke<Void>(0xF796359A959DF65D, toggle); } // 0xF796359A959DF65D 0xB5CC548B
	...
	inline void _REQUEST_VEHICLE_SCALEFORM_MOVIE(Vehicle vehicle) { invoke<Void>(0xDBA3C090E3D74690, vehicle); } // 0xDBA3C090E3D74690
	...
	inline void _GET_VEHICLE_SUSPENSION_DIMENSIONS(Vehicle vehicle, Vector3* out1, Vector3* out2) { invoke<Void>(0xDF7E3EEB29642C38, vehicle, out1, out2); } // 0xDF7E3EEB29642C38
...
namespace OBJECT
{
	inline Object CREATE_OBJECT(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C
	inline Object CREATE_OBJECT_NO_OFFSET(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x9A294B2138ABB884, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x9A294B2138ABB884 0x58040420
	...
	inline void _SET_OBJECT_LOD(Object object, BOOL toggle) { invoke<Void>(0x77F33F2CCF64B3AA, object, toggle); } // 0x77F33F2CCF64B3AA 0x483C5C88
	...
	inline void _DOOR_CONTROL(Hash doorHash, float x, float y, float z, BOOL locked, float xRotMult, float yRotMult, float zRotMult) { invoke<Void>(0x9B12F9A24FABEDB0, doorHash, x, y, z, locked, xRotMult, yRotMult, zRotMult); } // 0x9B12F9A24FABEDB0 0x4E0A260B
	...
	inline Pickup CREATE_AMBIENT_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int flag, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, flag, value, modelHash, returnHandle, p8); } // 0x673966A0C0FD7171 0x17B99CE7
	...
	inline void _0x0BF3B3BD47D79C08(Hash hash, int p1) { invoke<Void>(0x0BF3B3BD47D79C08, hash, p1); } // 0x0BF3B3BD47D79C08 0x7EFBA039
	...
	inline void SET_PICKUP_REGENERATION_TIME(Pickup pickup, int duration) { invoke<Void>(0x78015C9B4B3ECC9D, pickup, duration); } // 0x78015C9B4B3ECC9D 0xAB11267D
	...
	inline int* _0xDB41D07A45A6D4B7(Hash pickupHash) { return invoke<int*>(0xDB41D07A45A6D4B7, pickupHash); } // 0xDB41D07A45A6D4B7 0x000E92DC
...
namespace AI
{
	inline void TASK_PAUSE(Ped ped, int time) { invoke<Void>(0xE73A266DB0CA9042, ped, time); } // 0xE73A266DB0CA9042 0x17A64668
	...
	inline void TASK_ENTER_VEHICLE(Ped ped, Vehicle vehicle, int timeout, int seat, float speed, int flag, Any p6) { invoke<Void>(0xC20E50AA46D09CA8, ped, vehicle, timeout, seat, speed, flag, p6); } // 0xC20E50AA46D09CA8 0xB8689B4E
	...
	inline void TASK_STEALTH_KILL(Ped killer, Ped target, Hash actionType, float p3, Any p4) { invoke<Void>(0xAA5DC05579D60BD9, killer, target, actionType, p3, p4); } // 0xAA5DC05579D60BD9 0x0D64C2FA
	...
	inline void _SET_PED_PATH_SPEED(Ped ped, float p1) { invoke<Void>(0x88E32DB8C1A4AA4B, ped, p1); } // 0x88E32DB8C1A4AA4B 0x55E06443
	...
	inline int GET_NAVMESH_ROUTE_DISTANCE_REMAINING(Ped ped, float* distRemaining, BOOL* isPathReady) { return invoke<int>(0xC6F5C0BCDC74D62D, ped, distRemaining, isPathReady); } // 0xC6F5C0BCDC74D62D 0xD9281778
	...
	inline void STOP_ANIM_TASK(Ped ped, const char* animDictionary, const char* animationName, float blendoutSpeed) { invoke<Void>(0x97FF36A1D40EA00A, ped, animDictionary, animationName, blendoutSpeed); } // 0x97FF36A1D40EA00A 0x2B520A57
	...
	inline void TASK_AIM_GUN_AT_ENTITY(Ped ped, Entity entity, int duration, BOOL unk) { invoke<Void>(0x9B53BB6E8943AF53, ped, entity, duration, unk); } // 0x9B53BB6E8943AF53 0xBE32B3B6
	...
	inline void TASK_GOTO_ENTITY_OFFSET_XY(Ped ped, Entity entity, int duration, float xOffset, float yOffset, float zOffset, float moveBlendRatio, BOOL useNavmesh) { invoke<Void>(0x338E7EF52B6095A9, ped, entity, duration, xOffset, yOffset, zOffset, moveBlendRatio, useNavmesh); } // 0x338E7EF52B6095A9 0xBC1E3D0A
	...
	inline void TASK_VEHICLE_MISSION(int p0, int p1, Vehicle veh, Any p3, float p4, Any p5, float p6, float p7, BOOL p8) { invoke<Void>(0x659427E0EF36BCDE, p0, p1, veh, p3, p4, p5, p6, p7, p8); } // 0x659427E0EF36BCDE 0x20609E56
	...
	inline void _TASK_VEHICLE_FOLLOW(Ped driver, Vehicle vehicle, Entity targetEntity, float speed, int drivingStyle, int minDistance) { invoke<Void>(0xFC545A9F0626E3B6, driver, vehicle, targetEntity, speed, drivingStyle, minDistance); } // 0xFC545A9F0626E3B6
	...
	inline void TASK_CHAT_TO_PED(Ped ped, Ped target, int p2, float p3, float p4, float p5, float p6, float p7) { invoke<Void>(0x8C338E0263E4FD19, ped, target, p2, p3, p4, p5, p6, p7); } // 0x8C338E0263E4FD19 0xA2BE1821
	...
	inline void TASK_PERFORM_SEQUENCE_FROM_PROGRESS(Ped ped, Object taskSequence, int currentProgress, int progressToSetTo) { invoke<Void>(0x89221B16730234F0, ped, taskSequence, currentProgress, progressToSetTo); } // 0x89221B16730234F0 0xFA60601B
	...
	inline void TASK_PED_SLIDE_TO_COORD(Ped ped, float x, float y, float z, float heading, float duration) { invoke<Void>(0xD04FE6765D990A06, ped, x, y, z, heading, duration); } // 0xD04FE6765D990A06 0x225380EF
	...
	inline Any ADD_COVER_POINT(float posX, float posY, float posZ, float heading, BOOL p4, int p5, BOOL p6, BOOL p7) { return invoke<Any>(0xD5C12A75C7B9497F, posX, posY, posZ, heading, p4, p5, p6, p7); } // 0xD5C12A75C7B9497F 0xA0AF0B98
	...
	inline void TASK_COMBAT_PED_TIMED(Any p0, Ped ped, int duration, Any p3) { invoke<Void>(0x944F30DCB7096BDE, p0, ped, duration, p3); } // 0x944F30DCB7096BDE 0xF5CA2A45
	...
	inline void TASK_EXIT_COVER(Ped ped, int p1, float posX, float posY, float posZ) { invoke<Void>(0x79B258E397854D29, ped, p1, posX, posY, posZ); } // 0x79B258E397854D29 0xC829FAC9
	inline void TASK_PUT_PED_DIRECTLY_INTO_MELEE(Ped ped, Ped target, float p2, float p3, float p4, float flag) { invoke<Void>(0x1C6CD14A876FFE39, ped, target, p2, p3, p4, flag); } // 0x1C6CD14A876FFE39 0x79E1D27D
	...
	inline BOOL DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(float x, float y, float z, const char* scenarioName, float radius, BOOL p5) { return invoke<BOOL>(0x0A9D0C2A3BBC86C1, x, y, z, scenarioName, radius, p5); } // 0x0A9D0C2A3BBC86C1 0x0FB138A5
	inline BOOL IS_SCENARIO_OCCUPIED(float x, float y, float z, float radius, BOOL p4) { return invoke<BOOL>(0x788756D73AC2E07C, x, y, z, radius, p4); } // 0x788756D73AC2E07C 0x697FC008
	...
	inline void TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED(Ped ped, float radius, int duration, BOOL unk) { invoke<Void>(0x2BBA30B854534A0C, ped, radius, duration, unk); } // 0x2BBA30B854534A0C 0xF127AD6A
	...
	inline void TASK_VEHICLE_SHOOT_AT_PED(Ped ped, Ped target, float flag) { invoke<Void>(0x10AB107B887214D8, ped, target, flag); } // 0x10AB107B887214D8 0x59677BA0
	...
	inline float GET_PED_WAYPOINT_DISTANCE(Ped ped) { return invoke<float>(0xE6A877C64CAF1BC5, ped); } // 0xE6A877C64CAF1BC5 0x084B35B0
	inline Any SET_PED_WAYPOINT_ROUTE_OFFSET(Ped ped, float offsetX, float offsetY, float offsetZ) { return invoke<Any>(0xED98E10B0AFCE4B4, ped, offsetX, offsetY, offsetZ); } // 0xED98E10B0AFCE4B4 0xF867F747
	...
	inline void _WAYPOINT_PLAYBACK_START_SHOOTING_AT_PED(Any p0, Any p1, BOOL p2, Any p3) { invoke<Void>(0xE70BA7B90F8390DC, p0, p1, p2, p3); } // 0xE70BA7B90F8390DC
	...
	inline Any GET_VEHICLE_WAYPOINT_TARGET_POINT(Ped ped) { return invoke<Any>(0x416B62AC8B9E5BBD, ped); } // 0x416B62AC8B9E5BBD 0x81049608
	...
	inline BOOL _IS_TASK_MOVE_SCRIPTED_ACTIVE(Ped handle) { return invoke<BOOL>(0x921CE12C489C4C41, handle); } // 0x921CE12C489C4C41 0x902656EB
	inline BOOL _0x30ED88D5E0C56A37(Any p0) { return invoke<BOOL>(0x30ED88D5E0C56A37, p0); } // 0x30ED88D5E0C56A37 0x92FDBAE6
	inline Any _SET_NETWORK_TASK_ACTION(Ped ped, const char* p1) { return invoke<Any>(0xD01015C7316AE176, ped, p1); } // 0xD01015C7316AE176 0x885724DE
	inline Any _0xAB13A5565480B6D9(Ped ped, const char* unk) { return invoke<Any>(0xAB13A5565480B6D9, ped, unk); } // 0xAB13A5565480B6D9
	inline const char* _GET_PED_NETWORK_TASK_PHASE(Ped ped) { return invoke<const char*>(0x717E4D1F2048376D, ped); } // 0x717E4D1F2048376D 0x96C0277B
	inline void _SET_NETWORK_TASK_PARAM_FLOAT(Ped ped, const char* p1, float p2) { invoke<Void>(0xD5BB4025AE449A4E, ped, p1, p2); } // 0xD5BB4025AE449A4E 0xA79BE783
	inline void _SET_NETWORK_TASK_PARAM_BOOL(Ped ped, const char* p1, BOOL p2) { invoke<Void>(0xB0A6CFD2C69C1088, ped, p1, p2); } // 0xB0A6CFD2C69C1088 0xF3538041
	inline BOOL _0xA7FFBA498E4AAF67(Ped ped, const char* p1) { return invoke<BOOL>(0xA7FFBA498E4AAF67, ped, p1); } // 0xA7FFBA498E4AAF67 0x1EBB6F3D
	inline BOOL _0xB4F47213DF45A64C(Ped ped, const char* p1) { return invoke<BOOL>(0xB4F47213DF45A64C, ped, p1); } // 0xB4F47213DF45A64C 0x72FA5EF2
	...
	inline void TASK_SWEEP_AIM_ENTITY(Ped ped, const char* animDict, const char* animName1, const char* animName2, const char* animName3, int duration, Entity entity, float p7, float p8) { invoke<Void>(0x2047C02158D6405A, ped, animDict, animName1, animName2, animName3, duration, entity, p7, p8); } // 0x2047C02158D6405A 0x4D210467
...
namespace GAMEPLAY
{
	...
	inline int _GET_FREE_STACK_SLOTS_COUNT(int threadId) { return invoke<int>(0xFEAD16FC8F9DFC0F, threadId); } // 0xFEAD16FC8F9DFC0F 0x11A178B8
	...
	inline void SET_MISSION_FLAG(BOOL setToTrueOrNot) { invoke<Void>(0xC4301E5121A0ED73, setToTrueOrNot); } // 0xC4301E5121A0ED73 0x57592D52
	inline BOOL GET_MISSION_FLAG() { return invoke<BOOL>(0xA33CDCCDA663159E); } // 0xA33CDCCDA663159E 0x95115F97
	inline void SET_RANDOM_EVENT_FLAG(BOOL setToTrueOrNot) { invoke<Void>(0x971927086CFD2158, setToTrueOrNot); } // 0x971927086CFD2158 0xA77F31E8
	inline BOOL GET_RANDOM_EVENT_FLAG() { return invoke<BOOL>(0xD2D57F1D764117B1); } // 0xD2D57F1D764117B1 0x794CC92C
	inline const char* _GET_GLOBAL_CHAR_BUFFER() { return invoke<const char*>(0x24DA7D7667FD7B09); } // 0x24DA7D7667FD7B09
	inline void _0x4DCDF92BF64236CD(const char* p0, const char* p1) { invoke<Void>(0x4DCDF92BF64236CD, p0, p1); } // 0x4DCDF92BF64236CD
	...
	inline BOOL _0xE8B9C0EC9E183F35() { return invoke<BOOL>(0xE8B9C0EC9E183F35); } // 0xE8B9C0EC9E183F35
	...
	inline BOOL _0xB335F761606DB47C(Any* p1, Any* p2, Any p3, BOOL p4) { return invoke<BOOL>(0xB335F761606DB47C, p1, p2, p3, p4); } // 0xB335F761606DB47C
	...
	inline void _GET_WEATHER_TYPE_TRANSITION(Any p1, Any p2, Any p3) { invoke<Void>(0xF3BBE884A14BB413, p1, p2, p3); } // 0xF3BBE884A14BB413 0x9A5C1D56
	inline void _SET_WEATHER_TYPE_TRANSITION(Any p1, Any p2, Any p3) { invoke<Void>(0x578C752848ECFA0C, p1, p2, p3); } // 0x578C752848ECFA0C 0x5CA74040
	...
	inline void _SET_NEARBY_WAVE_HEIGHT(float p0) { invoke<Void>(0xC54A08C85AE4D410, p0); } // 0xC54A08C85AE4D410 0xDA02F415
	...
	inline float GET_RAIN_LEVEL() { return invoke<float>(0x96695E368AD855F3); } // 0x96695E368AD855F3 0xC9F67F28
	inline float GET_SNOW_LEVEL() { return invoke<float>(0xC5868A966E5BE3AE); } // 0xC5868A966E5BE3AE 0x1B09184F
	inline void FORCE_LIGHTNING_FLASH() { invoke<Void>(0xF6062E089251C898); } // 0xF6062E089251C898 0xDF38165E
	inline void _0x02DEAAC8F8EA7FE7(const char* p0) { invoke<Void>(0x02DEAAC8F8EA7FE7, p0); } // 0x02DEAAC8F8EA7FE7
	inline void PRELOAD_CLOUD_HAT(const char* name) { invoke<Void>(0x11B56FBBF7224868, name); } // 0x11B56FBBF7224868 0x8727A4C5
	inline void LOAD_CLOUD_HAT(const char* name, float transitionTime) { invoke<Void>(0xFC4842A34657BFCB, name, transitionTime); } // 0xFC4842A34657BFCB 0xED88FC61
	inline void UNLOAD_CLOUD_HAT(const char* name, float p1) { invoke<Void>(0xA74802FB8D0B7814, name, p1); } // 0xA74802FB8D0B7814 0xC9FA6E07
	...
	inline BOOL GET_GROUND_Z_FOR_3D_COORD(float x, float y, float z, float* groundZ, BOOL ignoreWater) { return invoke<BOOL>(0xC906A7DAB05C8D2B, x, y, z, groundZ, ignoreWater); } // 0xC906A7DAB05C8D2B 0xA1BFD5E0
	inline BOOL GET_GROUND_Z_AND_NORMAL_FOR_3D_COORD(float x, float y, float z, float* groundZ, Vector3* offsets) { return invoke<BOOL>(0x8BDC7BFC57A81E76, x, y, z, groundZ, offsets); } // 0x8BDC7BFC57A81E76 0x64D91CED
	...
	inline Hash GET_HASH_KEY(const char* string) { return invoke<Hash>(0xD24D37CC275948CC, string); } // 0xD24D37CC275948CC 0x98EFF6F1
	...
	inline void CLEAR_AREA_OF_PROJECTILES(float x, float y, float z, float radius, BOOL isNetworkGame) { invoke<Void>(0x0A1CB9094635D1A6, x, y, z, radius, isNetworkGame); } // 0x0A1CB9094635D1A6 0x18DB5434
	inline void _0x7EC6F9A478A6A512() { invoke<Void>(0x7EC6F9A478A6A512); } // 0x7EC6F9A478A6A512
	inline void SET_SAVE_MENU_ACTIVE(BOOL openSaveMenu) { invoke<Void>(0xC9BF75D28165FF77, openSaveMenu); } // 0xC9BF75D28165FF77 0xF5CCF164
	...
	inline BOOL HAVE_CREDITS_REACHED_END() { return invoke<BOOL>(0x075F1D57402C93BA); } // 0x075F1D57402C93BA 0x2569C9A7
	...
	inline int ADD_HOSPITAL_RESTART(float x, float y, float z, float heading, int hospitalId) { return invoke<int>(0x1F464EF988465A81, x, y, z, heading, hospitalId); } // 0x1F464EF988465A81 0x4F3E3104
	...
	inline void SET_SAVE_HOUSE(int index, BOOL p1, BOOL p2) { invoke<Void>(0x4F548CABEAE553BC, index, p1, p2); } // 0x4F548CABEAE553BC 0xC3240BB4
	...
	inline void ADD_REPLAY_STAT_VALUE(Any value) { invoke<Void>(0x69FE6DC87BD2A5E9, value); } // 0x69FE6DC87BD2A5E9 0x81216EE0
	...
	inline BOOL _0xD3D15555431AB793() { return invoke<BOOL>(0xD3D15555431AB793); } // 0xD3D15555431AB793 0xBAF17315
	...
	inline BOOL IS_PROJECTILE_TYPE_WITHIN_DISTANCE(float x, float y, float z, Hash projHash, float radius, BOOL ownedByPlayer) { return invoke<BOOL>(0x34318593248C8FB2, x, y, z, projHash, radius, ownedByPlayer); } // 0x34318593248C8FB2 0xBE81F1E2
	inline BOOL _GET_IS_PROJECTILE_TYPE_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2, Hash projHash, Vector3* projPos, BOOL ownedByPlayer) { return invoke<BOOL>(0x8D7A43EC6A5FEA45, x1, y1, z1, x2, y2, z2, projHash, projPos, ownedByPlayer); } // 0x8D7A43EC6A5FEA45 0x1A40454B
	inline BOOL _GET_PROJECTILE_NEAR_PED_COORDS(Ped ped, Hash projHash, float radius, Vector3* projPos, BOOL ownedByPlayer) { return invoke<BOOL>(0xDFB4138EEFED7B81, ped, projHash, radius, projPos, ownedByPlayer); } // 0xDFB4138EEFED7B81 0x6BDE5CE4
	inline BOOL _GET_PROJECTILE_NEAR_PED(Ped ped, Hash projHash, float radius, Vector3* projPos, Entity* projEnt, BOOL ownedByPlayer) { return invoke<BOOL>(0x82FDE6A57EE4EE44, ped, projHash, radius, projPos, projEnt, ownedByPlayer); } // 0x82FDE6A57EE4EE44 0x507BC6F7
	...
	inline void DELETE_STUNT_JUMP(int player) { invoke<Void>(0xDC518000E39DAE1F, player); } // 0xDC518000E39DAE1F 0x840CB5DA
	...
	inline void _ENABLE_ALL_STUNTJUMP_SETS(BOOL p0) { invoke<Void>(0xD79185689F8FD5DF, p0); } // 0xD79185689F8FD5DF 0x3C806A2D
	...
	inline int _0x996DD1E1E02F1008() { return invoke<int>(0x996DD1E1E02F1008); } // 0x996DD1E1E02F1008 0x006F9BA2
	inline int _0x6856EC3D35C81EA4() { return invoke<int>(0x6856EC3D35C81EA4); } // 0x6856EC3D35C81EA4
	...
	inline int _0xA09F896CE912481F(BOOL p0) { return invoke<int>(0xA09F896CE912481F, p0); } // 0xA09F896CE912481F 0x9EF0BC64
	...
	inline void ENABLE_DISPATCH_SERVICE(int dispatchType, BOOL toggle) { invoke<Void>(0xDC0F817884CDD856, dispatchType, toggle); } // 0xDC0F817884CDD856 0x0B710A51
	inline void BLOCK_DISPATCH_SERVICE_RESOURCE_CREATION(int dispatchType, BOOL toggle) { invoke<Void>(0x9B2BD3773123EA2F, dispatchType, toggle); } // 0x9B2BD3773123EA2F 0xE0F0684F
	...
	inline void _SAVE_NEXT_KEYBOARD_INPUT(int p0) { invoke<Void>(0x3ED1438C1F5C6612, p0); } // 0x3ED1438C1F5C6612 0x3301EA47
	inline void _REMOVE_STEALTH_KILL(Hash hash, BOOL p1) { invoke<Void>(0xA6A12939F16D85BE, hash, p1); } // 0xA6A12939F16D85BE 0x42B484ED
	...
	inline void _START_BENCHMARK_TEST() { invoke<Void>(0x92790862E36C2ADA); } // 0x92790862E36C2ADA
	...
	inline BOOL _HAS_ALL_CHUNKS_ON_HDD() { return invoke<BOOL>(0x14832BF2ABA53FC5); } // 0x14832BF2ABA53FC5
	inline void _CLEANUP_ASYNC_INSTALL() { invoke<Void>(0xC79AE21974B01FB2); } // 0xC79AE21974B01FB2
	...
	inline void _SET_SHOW_PED_IN_PAUSE_MENU(BOOL toggle) { invoke<Void>(0x4EBB7E87AA0DBED4, toggle); } // 0x4EBB7E87AA0DBED4
	inline BOOL _GET_SHOW_PED_IN_PAUSE_MENU() { return invoke<BOOL>(0x9689123E3F213AA5); } // 0x9689123E3F213AA5
...
namespace AUDIO
{
	...
	inline void ADD_PED_TO_CONVERSATION(int pedIndex, Ped ped, const char* name) { invoke<Void>(0x95D9F4BC443956E7, pedIndex, ped, name); } // 0x95D9F4BC443956E7 0xF8D5EB86
	...
	inline void PAUSE_SCRIPTED_CONVERSATION(BOOL finishCurLine) { invoke<Void>(0x8530AD776CD72B12, finishCurLine); } // 0x8530AD776CD72B12 0xE2C9C6F8
	...
	inline void INTERRUPT_CONVERSATION(Ped targ, const char* gxtLine, const char* const charName) { invoke<Void>(0xA018A12E5C5C2FA6, targ, gxtLine, charName); } // 0xA018A12E5C5C2FA6 0xF3A67AF3
	inline void _INTERRUPT_CONVERSATION_AND_PAUSE(Ped p0, const char* p1, const char* p2) { invoke<Void>(0x8A694D7A68F8DC38, p0, p1, p2); } // 0x8A694D7A68F8DC38
	...
	inline BOOL REQUEST_MISSION_AUDIO_BANK(const char* p0, BOOL p1) { return invoke<BOOL>(0x7345BDD95E62E0F2, p0, p1); } // 0x7345BDD95E62E0F2 0x916E37CA
	inline BOOL REQUEST_AMBIENT_AUDIO_BANK(const char* p0, BOOL p1) { return invoke<BOOL>(0xFE02FFBED8CA9D99, p0, p1); } // 0xFE02FFBED8CA9D99 0x23C88BC7
	inline BOOL REQUEST_SCRIPT_AUDIO_BANK(const char* p0, BOOL p1) { return invoke<BOOL>(0x2F844A8B08D76685, p0, p1); } // 0x2F844A8B08D76685 0x21322887
	...
	inline void SET_VARIABLE_ON_SOUND(int soundId, const char* variableName, float value) { invoke<Void>(0xAD6B3148A78AE9B6, soundId, variableName, value); } // 0xAD6B3148A78AE9B6 0x606EE5FA
	...
	inline void _PLAY_AMBIENT_SPEECH1(Ped ped, const char* speechName, const char* speechParam) { invoke<Void>(0x8E04FEDD28D42462, ped, speechName, speechParam); } // 0x8E04FEDD28D42462 0x5C57B85D
	inline void _PLAY_AMBIENT_SPEECH2(Ped ped, const char* speechName, const char* speechParam) { invoke<Void>(0xC6941B4A3A8FBBB9, ped, speechName, speechParam); } // 0xC6941B4A3A8FBBB9 0x444180DB
	...
	inline void _PLAY_AMBIENT_SPEECH_AT_COORDS(const char* speechName, const char* voiceName, float x, float y, float z, const char* speechParam) { invoke<Void>(0xED640017ED337E45, speechName, voiceName, x, y, z, speechParam); } // 0xED640017ED337E45 0xA1A1402E
	inline void OVERRIDE_TREVOR_RAGE(const char* p0) { invoke<Void>(0x13AD665062541A7E, p0); } // 0x13AD665062541A7E 0x05B9B5CF
	...
	inline void _0xD01005D2BA2EB778(const char* p0) { invoke<Void>(0xD01005D2BA2EB778, p0); } // 0xD01005D2BA2EB778 0x59A3A17D
	inline void _0xDDC635D5B3262C56(const char* p0) { invoke<Void>(0xDDC635D5B3262C56, p0); } // 0xDDC635D5B3262C56 0x0E387BFE
	...
	inline void _PLAY_ANIMAL_VOCALIZATION(Entity entity, int unk, const char* speech) { invoke<Void>(0xEE066C7006C49C0A, entity, unk, speech); } // 0xEE066C7006C49C0A 0x498849F3
	inline BOOL _IS_ANIMAL_VOCALIZATION_PLAYING(Any p0) { return invoke<BOOL>(0xC265DF9FB44A9FBD, p0); } // 0xC265DF9FB44A9FBD 0x0CBAF2EF
	...
	inline void _TUNE_FORWARD() { invoke<Void>(0xFF266D1D0EB1195D); } // 0xFF266D1D0EB1195D 0x53DB6994
	inline void _TUNE_BACKWARD() { invoke<Void>(0xDD6BCF9E94425DF9); } // 0xDD6BCF9E94425DF9 0xD70ECC80
	...
	inline void SET_inline_EMITTER_ENABLED(const char* emitterName, BOOL toggle) { invoke<Void>(0x399D2D3B33F1B8EB, emitterName, toggle); } // 0x399D2D3B33F1B8EB 0x91F72E92
	...
	inline void SET_RADIO_TRACK(const char* radioStation, const char* effectOrEvent) { invoke<Void>(0xB39786F201FEE30B, radioStation, effectOrEvent); } // 0xB39786F201FEE30B 0x76E96212
	...
	inline BOOL _DOES_PLAYER_VEH_HAVE_RADIO() { return invoke<BOOL>(0x109697E2FFBAC8A1); } // 0x109697E2FFBAC8A1 0x46B0C696
	...
	inline void _SET_CUSTOM_RADIO_TRACK_LIST(const char* radioStation, const char* trackList, BOOL b) { invoke<Void>(0x4E404A9361F75BB2, radioStation, trackList, b); } // 0x4E404A9361F75BB2 0x128C3873
	inline void _CLEAR_CUSTOM_RADIO_TRACK_LIST(const char* radioStation) { invoke<Void>(0x1654F24A88A8E3FE, radioStation); } // 0x1654F24A88A8E3FE 0x1D766976
	...
	inline void _SET_RADIO_STATION_MUSIC_ONLY(const char* radioStation, BOOL p1) { invoke<Void>(0x774BD811F656A122, radioStation, p1); } // 0x774BD811F656A122 0xB1FF7137
	...
	inline void SET_AMBIENT_ZONE_LIST_STATE(const char* p0, BOOL p1, BOOL p2) { invoke<Void>(0x9748FA4DE50CCE3E, p0, p1, p2); } // 0x9748FA4DE50CCE3E 0xBF80B412
	...
	inline void _FORCE_VEHICLE_ENGINE_AUDIO(Vehicle vehicle, const char* audioName) { invoke<Void>(0x4F0C413926060B38, vehicle, audioName); } // 0x4F0C413926060B38 0x33B0B007
	...
	inline void _ENABLE_STALL_WARNING_SOUNDS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xC15907D667F7CFB2, vehicle, toggle); } // 0xC15907D667F7CFB2 0x563B635D
	...
	inline void _0x18EB48CFC41F2EA0(Ped p, float p1) { invoke<Void>(0x18EB48CFC41F2EA0, p, p1); } // 0x18EB48CFC41F2EA0 0x308ED0EC
	...
	inline Any PREPARE_SYNCHRONIZED_AUDIO_EVENT(const char* audioName, BOOL unk) { return invoke<Any>(0xC7ABCACA4985A766, audioName, unk); } // 0xC7ABCACA4985A766 0xE1D91FD0
	inline BOOL PREPARE_SYNCHRONIZED_AUDIO_EVENT_FOR_SCENE(int SceneID, const char* audioName) { return invoke<BOOL>(0x029FE7CD1B7E2E75, SceneID, audioName); } // 0x029FE7CD1B7E2E75 0x7652DD49
...
namespace CUTSCENE
{
	inline void REQUEST_CUTSCENE(const char* cutsceneName, int id) { invoke<Void>(0x7A86743F475D9E09, cutsceneName, id); } // 0x7A86743F475D9E09 0xB5977853
	...
	inline void START_CUTSCENE(int id) { invoke<Void>(0x186D5CB5E7B0FF7B, id); } // 0x186D5CB5E7B0FF7B 0x210106F6
	...
	inline void _0x011883F41211432A(float x1, float y1, float z1, float x2, float y2, float z2, int p6) { invoke<Void>(0x011883F41211432A, x1, y1, z1, x2, y2, z2, p6); } // 0x011883F41211432A
	...
	inline BOOL _0x5EDEF0CF8C1DAB3C() { return invoke<BOOL>(0x5EDEF0CF8C1DAB3C); } // 0x5EDEF0CF8C1DAB3C 0xDBD88708
	...
	inline BOOL HAS_CUTSCENE_CUT_THIS_FRAME() { return invoke<BOOL>(0x708BDD8CD795B043); } // 0x708BDD8CD795B043 0x4315A7C5
}
...
namespace CAM
{
	...
	inline Cam CREATE_CAM(const char* camName, BOOL unk) { return invoke<Cam>(0xC3981DCE61D9E13F, camName, unk); } // 0xC3981DCE61D9E13F 0xE9BF2A7D
	...
	inline void SET_CAM_ROT(Cam cam, float pitch, float roll, float yaw, int rotationOrder) { invoke<Void>(0x85973643155D0B07, cam, pitch, roll, yaw, rotationOrder); } // 0x85973643155D0B07 0xEE38B3C1
	...
	inline void ADD_CAM_SPLINE_NODE(Cam camera, float x, float y, float z, float xRot, float yRot, float zRot, int length, int p8, int transitionType) { invoke<Void>(0x8609C75EC438FB3B, camera, x, y, z, xRot, yRot, zRot, length, p8, transitionType); } // 0x8609C75EC438FB3B 0xAD3C7EAA
	...
	inline int GET_CAM_SPLINE_NODE_INDEX(Cam cam) { return invoke<int>(0xB22B17DF858716A6, cam); } // 0xB22B17DF858716A6 0xF8AEB6BD
	...
	inline BOOL PLAY_SYNCHRONIZED_CAM_ANIM(Cam camera, int SceneID, const char* animName, const char* animDictionary) { return invoke<BOOL>(0xE32EFE9AB4A9AA0C, camera, SceneID, animName, animDictionary); } // 0xE32EFE9AB4A9AA0C 0x9458459E
	inline void SET_FLY_CAM_HORIZONTAL_RESPONSE(Any p0, float p1, float p2, float p3) { invoke<Void>(0x503F5920162365B2, p0, p1, p2, p3); } // 0x503F5920162365B2 0x56F9ED27
	inline void SET_FLY_CAM_MAX_HEIGHT(Cam cam, float range) { invoke<Void>(0xF9D02130ECDD1D77, cam, range); } // 0xF9D02130ECDD1D77 0x71570DBA
	inline void SET_FLY_CAM_COORD_AND_CONSTRAIN(Any p0, float p1, float p2, float p3) { invoke<Void>(0xC91C6C55199308CA, p0, p1, p2, p3); } // 0xC91C6C55199308CA 0x60B345DE
	...
	inline void SET_WIDESCREEN_BORDERS(BOOL toggle, int duration) { invoke<Void>(0xDCD4EA924F42D01A, toggle, duration); } // 0xDCD4EA924F42D01A 0x1A75DC9A
	...
	inline int _GET_CAM_VIEW_MODE(int viewType) { return invoke<int>(0xEE778F8C7E1142E2, viewType); } // 0xEE778F8C7E1142E2 0xF3B148A6
	inline void _SET_CAM_PERSPECTIVE(Cam p0, Any perspective) { invoke<Void>(0x2A2173E46DAECD12, p0, perspective); } // 0x2A2173E46DAECD12 0x1DEBCB45
	inline int _GET_CAM_VIEW_TYPE() { return invoke<int>(0x19CAFA3C87F7C2FF); } // 0x19CAFA3C87F7C2FF
	...
	inline void _SET_FIRST_PERSON_CAM_PITCH_RANGE(float minAngle, float maxAngle) { invoke<Void>(0xBCFC632DB7673BF0, minAngle, maxAngle); } // 0xBCFC632DB7673BF0 0x76DAC96C
	inline void _SET_FIRST_PERSON_CAM_NEAR_CLIP(float distance) { invoke<Void>(0x0AF7B437918103B3, distance); } // 0x0AF7B437918103B3 0x0E21069D
	inline void _SET_THIRD_PERSON_AIM_CAM_NEAR_CLIP(float distance) { invoke<Void>(0x42156508606DE65E, distance); } // 0x42156508606DE65E 0x71E9C63E
	...
	inline float _GET_GAMEPLAY_CAM_FOV() { return invoke<float>(0x80EC114669DAEFF4); } // 0x80EC114669DAEFF4 0x721B763B
	...
	inline float _GET_GAMEPLAY_CAM_FAR_CLIP() { return invoke<float>(0xDFC8CBC606FDB0FC); } // 0xDFC8CBC606FDB0FC 0x46CB3A49
	inline float _GET_GAMEPLAY_CAM_NEAR_DOF() { return invoke<float>(0xA03502FC581F7D9B); } // 0xA03502FC581F7D9B 0x19297A7A
	inline float _GET_GAMEPLAY_CAM_FAR_DOF() { return invoke<float>(0x9780F32BCAF72431); } // 0x9780F32BCAF72431 0xF24777CA
	...
	inline void SET_GAMEPLAY_VEHICLE_HINT(Vehicle p0, float xOffset, float yOffset, float zOffset, BOOL p4, int duration, int easeInDuration, int easeOutDuration) { invoke<Void>(0xA2297E18F3E71C2E, p0, xOffset, yOffset, zOffset, p4, duration, easeInDuration, easeOutDuration); } // 0xA2297E18F3E71C2E 0x2C9A11D8
	...
	inline void SET_GAMEPLAY_ENTITY_HINT(Entity entity, float xOffset, float yOffset, float zOffset, BOOL p4, int duration, int fadeInTime, int fadeOutTime, int flags) { invoke<Void>(0x189E955A8313E298, entity, xOffset, yOffset, zOffset, p4, duration, fadeInTime, fadeOutTime, flags); } // 0x189E955A8313E298 0x66C32306
	...
	inline void _F4F2C0D4EE209E20() { invoke<Void>(0xF4F2C0D4EE209E20); } // 0xF4F2C0D4EE209E20 0xD75CDD75
	...
	inline float _GET_REPLAY_FREE_CAM_MAX_RANGE() { return invoke<float>(0x8BFCEB5EA1B161B6); } // 0x8BFCEB5EA1B161B6
}
...
namespace WEAPON
{
	...
	inline BOOL GET_CURRENT_PED_WEAPON(Ped ped, Hash* weaponHash, BOOL unused) { return invoke<BOOL>(0x3A87E44BB9A01D54, ped, weaponHash, unused); } // 0x3A87E44BB9A01D54 0xB0237302
	...
	inline void REMOVE_ALL_PED_WEAPONS(Ped ped, BOOL unused) { invoke<Void>(0xF25DF915FA38C5F3, ped, unused); } // 0xF25DF915FA38C5F3 0xA44CE817
	...
	inline void SET_PED_AMMO_BY_TYPE(Ped ped, Hash ammoType, int ammo) { invoke<Void>(0x5FD1E1F011E76D7E, ped, ammoType, ammo); } // 0x5FD1E1F011E76D7E 0x311C52BB
	inline int GET_PED_AMMO_BY_TYPE(Ped ped, Hash ammoType) { return invoke<int>(0x39D22031557946C1, ped, ammoType); } // 0x39D22031557946C1 0x54077C4D
	inline void SET_PED_AMMO_TO_DROP(Any ammoType, int ammo) { invoke<Void>(0xA4EFEF9440A5B0EF, ammoType, ammo); } // 0xA4EFEF9440A5B0EF 0x2386A307
	...
	inline float GET_LOCKON_DISTANCE_OF_CURRENT_PED_WEAPON(Ped ped) { return invoke<float>(0x840F03E9041E2C9C, ped); } // 0x840F03E9041E2C9C 0x3612110D
	...
	inline void REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(Object weaponObject, Hash component) { invoke<Void>(0xF7D82B0D66777611, weaponObject, component); } // 0xF7D82B0D66777611 0xA6E7ED3C
	...
	inline BOOL GET_WEAPON_HUD_STATS(Hash weaponHash, Any* outData) { return invoke<BOOL>(0xD92C739EE34C9EBA, weaponHash, outData); } // 0xD92C739EE34C9EBA 0xA9AD3D98
	...
	inline float _0x3133B907D8B32053(Hash weapon, int p1) { return invoke<float>(0x3133B907D8B32053, weapon, p1); } // 0x3133B907D8B32053
	...
	inline Entity SET_PED_SHOOT_ORDNANCE_WEAPON(Ped ped, BOOL p1) { return invoke<Entity>(0xB4C8D77C80C0421E, ped, p1); } // 0xB4C8D77C80C0421E 0xEC2E5304
...
namespace ITEMSET
{
	inline Vehicle CREATE_ITEMSET(Vehicle distri) { return invoke<Vehicle>(0x35AD299F50D91B24, distri); } // 0x35AD299F50D91B24 0x0A113B2C
	...
	inline Any GET_ITEMSET_SIZE(ScrHandle x) { return invoke<Any>(0xD9127E83ABF7C631, x); } // 0xD9127E83ABF7C631 0x2B31F41A
...
namespace STREAMING
{
	...
	inline Vector3* NETWORK_UPDATE_LOAD_SCENE() { return invoke<Vector3*>(0xC4582015556D1C46); } // 0xC4582015556D1C46 0xC76E023C
	...
	inline void REQUEST_MENU_PED_MODEL(Player model) { invoke<Void>(0xA0261AEF7ACFC51E, model); } // 0xA0261AEF7ACFC51E 0x48CEB6B4
	...
	inline void REQUEST_ADDITIONAL_COLLISION_AT_COORD(float x, float y, float z) { invoke<Void>(0xC9156DC11411A9EA, x, y, z); } // 0xC9156DC11411A9EA 0xC2CC1DF2
	...
	inline void REQUEST_NAMED_PTFX_ASSET(const char* assetName) { invoke<Void>(0xB80D8756B4668AB6, assetName); } // 0xB80D8756B4668AB6 0xCFEA19A9
	inline BOOL HAS_NAMED_PTFX_ASSET_LOADED(const char* assetName) { return invoke<BOOL>(0x8702416E512EC454, assetName); } // 0x8702416E512EC454 0x9ACC6446
	inline void _REMOVE_NAMED_PTFX_ASSET(const char* assetName) { invoke<Void>(0x5F61EBBE1A00F96D, assetName); } // 0x5F61EBBE1A00F96D
	inline void SET_VEHICLE_POPULATION_BUDGET(int budget) { invoke<Void>(0xCB9E1EB3BE2AF4E9, budget); } // 0xCB9E1EB3BE2AF4E9 0x1D56993C
	inline void SET_PED_POPULATION_BUDGET(int budget) { invoke<Void>(0x8C95333CFC3340F3, budget); } // 0x8C95333CFC3340F3 0xD2D026CD
	inline void CLEAR_FOCUS() { invoke<Void>(0x31B73D1EA9F01DA2); } // 0x31B73D1EA9F01DA2 0x34D91E7A
	inline void SET_FOCUS_POS_AND_VEL(float x, float y, float z, float offsetX, float offsetY, float offsetZ) { invoke<Void>(0xBB7454BAFF08FE25, x, y, z, offsetX, offsetY, offsetZ); } // 0xBB7454BAFF08FE25 0x14680A60
	...
	inline void _SET_MAPDATACULLBOX_ENABLED(const char* p0, BOOL p1) { invoke<Void>(0xAF12610C644A35C9, p0, p1); } // 0xAF12610C644A35C9 0x403CD434
	...
	inline BOOL _0x71E7B2E657449AAD() { return invoke<BOOL>(0x71E7B2E657449AAD); } // 0x71E7B2E657449AAD 0xEAA51103
	...
	inline void _0x5F2013F8BC24EE69(Any* p0) { invoke<Void>(0x5F2013F8BC24EE69, p0); } // 0x5F2013F8BC24EE69 0xF0BD420D
	inline int _0x78C0D93253149435() { return invoke<int>(0x78C0D93253149435); } // 0x78C0D93253149435 0x02BA7AC2
	inline void SET_PLAYER_SWITCH_OUTRO(float camCoordX, float camCoordY, float camCoordZ, float camRotX, float camRotY, float camRotZ, float camFOV, float camFarClip, int p8) { invoke<Void>(0xC208B673CE446B61, camCoordX, camCoordY, camCoordZ, camRotX, camRotY, camRotZ, camFOV, camFarClip, p8); } // 0xC208B673CE446B61 0x47352E14
	inline void _0x0FDE9DBFC0A6BC65(const char* p0) { invoke<Void>(0x0FDE9DBFC0A6BC65, p0); } // 0x0FDE9DBFC0A6BC65 0x279077B0
	...
	inline void _SWITCH_OUT_PLAYER(Ped ped, int flags, int switchType) { invoke<Void>(0xAAB3200ED59016BC, ped, flags, switchType); } // 0xAAB3200ED59016BC 0xFB4D062D
	inline void _SWITCH_IN_PLAYER(Ped ped) { invoke<Void>(0xD8295AF639FD9CB8, ped); } // 0xD8295AF639FD9CB8 0x2349373B
	inline BOOL _0x933BBEEB8C61B5F4() { return invoke<BOOL>(0x933BBEEB8C61B5F4); } // 0x933BBEEB8C61B5F4 0x74C16879
	...
	inline void _LOAD_MISSION_CREATOR_DATA() { invoke<Void>(0xB5A4DB34FE89B88A); } // 0xB5A4DB34FE89B88A 0xE243B2AF
...
namespace SCRIPT
{
	inline void REQUEST_SCRIPT(Player* Playermenu) { invoke<Void>(0x6EB5F71AA68F2E8E, Playermenu); } // 0x6EB5F71AA68F2E8E 0xE26B2666
	...
	inline int GET_NUMBER_OF_EVENTS(int eventGroup) { return invoke<int>(0x5F92A689A06620AA, eventGroup); } // 0x5F92A689A06620AA 0xA3525D60
	inline BOOL GET_EVENT_EXISTS(int eventGroup, int eventIndex) { return invoke<BOOL>(0x936E6168A9BCEDB5, eventGroup, eventIndex); } // 0x936E6168A9BCEDB5 0xA1B447B5
	inline int GET_EVENT_AT_INDEX(int eventGroup, int eventIndex) { return invoke<int>(0xD8F66A3A60C62153, eventGroup, eventIndex); } // 0xD8F66A3A60C62153 0xB49C1442
	inline BOOL GET_EVENT_DATA(int eventGroup, int eventIndex, int* argStruct, int argStructSize) { return invoke<BOOL>(0x2902843FCD2B2D79, eventGroup, eventIndex, argStruct, argStructSize); } // 0x2902843FCD2B2D79 0x4280F92F
	inline void TRIGGER_SCRIPT_EVENT(int eventGroup, Any* args, int argCount, int bit) { invoke<Void>(0x5AE99C571D5BBE5D, eventGroup, args, argCount, bit); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	inline void BEGIN_TEXT_COMMAND_BUSYSPINNER_ON(const char* string) { invoke<Void>(0xABA17D7CE615ADBF, string); } // 0xABA17D7CE615ADBF 0xCB7C8994
	inline void _END_TEXT_COMMAND_BUSY_STRING(int busySpinnerType) { invoke<Void>(0xBD12F8228410D9B4, busySpinnerType); } // 0xBD12F8228410D9B4 0x903F5EE4
	inline void _REMOVE_LOADING_PROMPT() { invoke<Void>(0x10D373323E5B9C0D); } // 0x10D373323E5B9C0D 0x94119534
	inline void _REMOVE_BUSY_SPINNER() { invoke<Void>(0xC65AB383CD91DF98); } // 0xC65AB383CD91DF98 0x71077FBD
	inline BOOL _IS_LOADING_PROMPT_BEING_DISPLAYED() { return invoke<BOOL>(0xD422FCC5F239A915); } // 0xD422FCC5F239A915 0xB8B3A5D0
	inline Pickup _0xB2A592B04648A9CB() { return invoke<Pickup>(0xB2A592B04648A9CB); } // 0xB2A592B04648A9CB
	...
	inline BOOL _0x3D9ACB1EB139E702() { return invoke<BOOL>(0x3D9ACB1EB139E702); } // 0x3D9ACB1EB139E702
	...
	inline void THEFEED_PAUSE() { invoke<Void>(0xFDB423997FA30340); } // 0xFDB423997FA30340 0x4D0449C6
	inline void THEFEED_RESUME() { invoke<Void>(0xE1CD1E48E025E661); } // 0xE1CD1E48E025E661 0xD3F40140
	inline BOOL THEFEED_IS_PAUSED() { return invoke<BOOL>(0xA9CBFD40B3FA3010); } // 0xA9CBFD40B3FA3010 0xC5223796
	...
	inline void _RESET_NOTIFICATION_DATA() { invoke<Void>(0xADED7F5748ACAFE6); } // 0xADED7F5748ACAFE6 0x1D6859CA
	...
	inline void BEGIN_TEXT_COMMAND_THEFEED_POST(const char* text) { invoke<Void>(0x202709F4C58A0424, text); } // 0x202709F4C58A0424 0x574EE85C
	inline int _SET_NOTIFICATION_MESSAGE(const char* picName1, const char* picName2, BOOL flash, int iconType, BOOL _nonExistent, const char* sender, const char* subject) { return invoke<int>(0x2B7E9A4EAAA93C89, picName1, picName2, flash, iconType, _nonExistent, sender, subject); } // 0x2B7E9A4EAAA93C89 0xED130FA1
	...
	inline int END_TEXT_COMMAND_THEFEED_POST_TICKER(BOOL blink, BOOL showInBrief) { return invoke<int>(0x2ED7843F8F801023, blink, showInBrief); } // 0x2ED7843F8F801023 0x08F7AF78
	inline int END_TEXT_COMMAND_THEFEED_POST_TICKER_FORCED(BOOL blink, BOOL p1) { return invoke<int>(0x44FA03975424A0EE, blink, p1); } // 0x44FA03975424A0EE 0x57B8D0D4
	...
	inline int END_TEXT_COMMAND_THEFEED_POST_CREWTAG_WITH_GAME_NAME(BOOL p0, BOOL p1, int* p2, int p3, BOOL isLeader, BOOL unk0, int clanDesc, const char* playerName, int R, int G, int B) { return invoke<int>(0x137BC35589E34E1E, p0, p1, p2, p3, isLeader, unk0, clanDesc, playerName, R, G, B); } // 0x137BC35589E34E1E 0x88B9B909
	inline int _DRAW_NOTIFICATION_UNLOCK(const char* unlockLabel, int iconType, const char* unk2) { return invoke<int>(0x33EE12743CCD6343, unlockLabel, iconType, unk2); } // 0x33EE12743CCD6343 0xE05E7052
	inline int _DRAW_NOTIFICATION_UNLOCK_2(const char* unlockLabel, int iconType, const char* unk2, int fadeInTime) { return invoke<int>(0xC8F3AAF93D0600BF, unlockLabel, iconType, unk2, fadeInTime); } // 0xC8F3AAF93D0600BF 0x4FA43BA4
	inline int END_TEXT_COMMAND_THEFEED_POST_UNLOCK_TU_WITH_COLOR(const char* primaryText, int iconType, const char* unk2, int fadeInTime, int primaryStyle, BOOL ignoreLoc) { return invoke<int>(0x7AE0589093A2E088, primaryText, iconType, unk2, fadeInTime, primaryStyle, ignoreLoc); } // 0x7AE0589093A2E088 0x8C90D22F
	...
	inline float _END_TEXT_COMMAND_GET_WIDTH(BOOL p0) { return invoke<float>(0x85F061DA64ED2F67, p0); } // 0x85F061DA64ED2F67 0xD12A643A
	...
	inline int _GET_TEXT_SCREEN_LINE_COUNT(float x, float y) { return invoke<int>(0x9040DFB09BE75706, x, y); } // 0x9040DFB09BE75706 0xAA318785
	...
	inline void END_TEXT_COMMAND_DISPLAY_HELP(Any p0, BOOL loop, BOOL beep, int duration) { invoke<Void>(0x238FFE5C7B0498A6, p0, loop, beep, duration); } // 0x238FFE5C7B0498A6 0xB59B530D
	...
	inline void BEGIN_TEXT_COMMAND_OVERRIDE_BUTTON_TEXT(const char* p0) { invoke<Void>(0x8F9EE5687F8EECCD, p0); } // 0x8F9EE5687F8EECCD 0xBF855650
	inline void END_TEXT_COMMAND_OVERRIDE_BUTTON_TEXT(BOOL p0) { invoke<Void>(0xA86911979638106F, p0); } // 0xA86911979638106F 0x6E7FDA1C
	...
	inline void ADD_TEXT_COMPONENT_SUBSTRING_PHONE_NUMBER(const char* p0, int p1) { invoke<Void>(0x761B77454205A61D, p0, p1); } // 0x761B77454205A61D 0x65E1D404
	...
	inline void ADD_TEXT_COMPONENT_SUBSTRING_KEYBOARD_DISPLAY(const char* p0) { invoke<Void>(0x5F68520888E69014, p0); } // 0x5F68520888E69014 0x0829A799
	...
	inline void _DISPLAY_HUD_WHEN_PAUSED_THIS_FRAME() { invoke<Void>(0x402F9ED62087E898); } // 0x402F9ED62087E898 0xC47AB1B0
	...
	inline void REPLACE_HUD_COLOUR(int hudColorIndex, int hudColorIndex2) { invoke<Void>(0x1CCC708F0F850613, hudColorIndex, hudColorIndex2); } // 0x1CCC708F0F850613 0x3B216749
	...
	inline void SET_ABILITY_BAR_VALUE(float value, float maxValue) { invoke<Void>(0x9969599CCFF5D85E, value, maxValue); } // 0x9969599CCFF5D85E 0x24E53FD8
	...
	inline void SET_TEXT_SCALE(float unk, float scale) { invoke<Void>(0x07C837F9A01C34C9, unk, scale); } // 0x07C837F9A01C34C9 0xB6E15B23
	...
	inline void TRIGGER_SONAR_BLIP(float posX, float posY, float posZ, float radius, int p4) { invoke<Void>(0x72DD432F3CDFC0EE, posX, posY, posZ, radius, p4); } // 0x72DD432F3CDFC0EE 0xBF25E7B2
	...
	inline void _0x75A16C3DA34F1245(Blip blip, BOOL p1) { invoke<Void>(0x75A16C3DA34F1245, blip, p1); } // 0x75A16C3DA34F1245 0x1D99F676
	inline void SHOW_TICK_ON_BLIP(Blip blip, BOOL toggle) { invoke<Void>(0x74513EA3E505181E, blip, toggle); } // 0x74513EA3E505181E 0x3DCF0092
	...
	inline Any SET_MINIMAP_COMPONENT(int component, BOOL toggle, int componentColor) { return invoke<Any>(0x75A9A10948D1DEA6, component, toggle, componentColor); } // 0x75A9A10948D1DEA6 0x419DCDC4
	...
	inline void SET_RADAR_AS_INTERIOR_THIS_FRAME(Hash interior, float x, float y, int heading, int zoom) { invoke<Void>(0x59E727A1C9D3E31A, interior, x, y, heading, zoom); } // 0x59E727A1C9D3E31A 0x6F2626E1
	...
	inline void _HIDE_CURRENT_INTERIOR_ON_MAP() { invoke<Void>(0x20FE7FDFEEAD38C0); } // 0x20FE7FDFEEAD38C0 0xCE36E3FE
	...
	inline void _UPDATE_DISPLAY_CASH(BOOL toggle) { invoke<Void>(0x170F541E1CADD1DE, toggle); } // 0x170F541E1CADD1DE
	...
	inline void _SET_DISPLAY_CASH() { invoke<Void>(0xC2D15BEF167E27BC); } // 0xC2D15BEF167E27BC 0xF4F3C796
	inline void _REMOVE_DISPLAY_CASH() { invoke<Void>(0x95CF81BD06EE1887); } // 0x95CF81BD06EE1887 0x7BFFE82F
	...
	inline void _BLOCK_WEAPON_WHEEL_THIS_FRAME() { invoke<Void>(0x0AFC4AF510774B47); } // 0x0AFC4AF510774B47 0xB26FED2B
	inline Hash _0xA48931185F0536FE() { return invoke<Hash>(0xA48931185F0536FE); } // 0xA48931185F0536FE 0x22E9F555
	inline void _HIDE_WEAPON_HASH(Hash weaponHash) { invoke<Void>(0x72C1056D678BB7D8, weaponHash); } // 0x72C1056D678BB7D8 0x83B608A0
	...
	inline void _0x311438A071DD9B1A(float x, float y, float z) { invoke<Void>(0x311438A071DD9B1A, x, y, z); } // 0x311438A071DD9B1A 0xEEBDFE55
	...
	inline void _SET_MISSION_NAME_2(BOOL p0, const char* name) { invoke<Void>(0xE45087D85F468BC2, p0, name); } // 0xE45087D85F468BC2 0x8D9A1734
	...
	inline void SET_MINIMAP_GOLF_COURSE(int hole) { invoke<Void>(0x71BDB63DBAF8DA59, hole); } // 0x71BDB63DBAF8DA59 0x5133A750
	...
	inline BOOL GET_HUD_SCREEN_POSITION_FROM_WORLD_POSITION(float worldX, float worldY, float worldZ, float* screenX, float* screenY) { return invoke<BOOL>(0xF9904D11F1ACBEC3, worldX, worldY, worldZ, screenX, screenY); } // 0xF9904D11F1ACBEC3 0xFE9A39F8
	inline void _DISPLAY_JOB_REPORT() { invoke<Void>(0x523A590C1A3CC0D3); } // 0x523A590C1A3CC0D3 0x10DE5150
	...
	inline BOOL IS_FLOATING_HELP_TEXT_ON_SCREEN(Any p0) { return invoke<BOOL>(0x2432784ACA090DA4, p0); } // 0x2432784ACA090DA4 0x45472FD5
	inline void SET_FLOATING_HELP_TEXT_SCREEN_POSITION(Any p0, float p1, float p2) { invoke<Void>(0x7679CC1BCEBE3D4C, p0, p1, p2); } // 0x7679CC1BCEBE3D4C 0x198F32D7
	inline void SET_FLOATING_HELP_TEXT_WORLD_POSITION(Any p0, float x, float y, float z) { invoke<Void>(0x784BA7E0ECEB4178, p0, x, y, z); } // 0x784BA7E0ECEB4178 0x93045157
	inline void SET_FLOATING_HELP_TEXT_TO_ENTITY(Any p0, Any p1, float p2, float p3) { invoke<Void>(0xB094BC1DB4018240, p0, p1, p2, p3); } // 0xB094BC1DB4018240 0x18B012B7
	inline void SET_FLOATING_HELP_TEXT_STYLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x788E7FD431BD67F1, p0, p1, p2, p3, p4, p5); } // 0x788E7FD431BD67F1 0x97852A82
	...
	inline BOOL IS_MP_GAMER_TAG_MOVIE_ACTIVE() { return invoke<BOOL>(0x6E0EB3EB47C8D7AA); } // 0x6E0EB3EB47C8D7AA 0xEFD2564A
	inline int CREATE_FAKE_MP_GAMER_TAG(Ped ped, const char* username, BOOL pointedClanTag, BOOL isRockstarClan, const char* clanTag, Any p5) { return invoke<int>(0xBFEFE3321A3F5015, ped, username, pointedClanTag, isRockstarClan, clanTag, p5); } // 0xBFEFE3321A3F5015 0xF5CD2AA4
	...
	inline int _GET_ACTIVE_WEBSITE_ID() { return invoke<int>(0x01A358D9128B7A86); } // 0x01A358D9128B7A86 0xAB5B7C18
	inline int GET_CURRENT_WEBSITE_ID() { return invoke<int>(0x97D47996FC48CBAD); } // 0x97D47996FC48CBAD 0x42A55B14
	inline BOOL _GET_CURRENT_WEBSITE_PAGE_ID(int websiteID) { return invoke<BOOL>(0xE3B05614DCE1D014, websiteID); } // 0xE3B05614DCE1D014 0xD217EE7E
	...
	inline BOOL _CREATE_DRAW_LIST(Any p0, const char* text, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x0C5A80A9E096D529, p0, text, p2, p3, p4, p5); } // 0x0C5A80A9E096D529
	...
	inline void _0x77F16B447824DA6C(int p0) { invoke<Void>(0x77F16B447824DA6C, p0); } // 0x77F16B447824DA6C 0x0A89336C
	inline void _0xCDCA26E80FAECB8F() { invoke<Void>(0xCDCA26E80FAECB8F); } // 0xCDCA26E80FAECB8F 0xC84BE309
	inline void PAUSE_MENU_ACTIVATE_CONTEXT(Hash contextHash) { invoke<Void>(0xDD564BDD0472C936, contextHash); } // 0xDD564BDD0472C936 0x9FE8FD5E
	inline void OBJECT_DECAL_TOGGLE(Hash contextHash) { invoke<Void>(0x444D8CF241EC25C5, contextHash); } // 0x444D8CF241EC25C5 0x0029046E
	...
	inline BOOL _0x2E22FEFA0100275E() { return invoke<BOOL>(0x2E22FEFA0100275E); } // 0x2E22FEFA0100275E 0x96863460
	...
	inline void _0x7E17BE53E1AAABAF(int* p0, int* p1, int* p2) { invoke<Void>(0x7E17BE53E1AAABAF, p0, p1, p2); } // 0x7E17BE53E1AAABAF 0x6025AA2F
	...
	inline void _SET_PED_AI_BLIP(int pedHandle, BOOL showViewCones) { invoke<Void>(0xD30C50DF888D58B5, pedHandle, showViewCones); } // 0xD30C50DF888D58B5 0x96C4C4DD
	inline BOOL DOES_PED_HAVE_AI_BLIP(Ped ped) { return invoke<BOOL>(0x15B8ECF844EE67ED, ped); } // 0x15B8ECF844EE67ED 0x3BE1257F
	inline void _SET_AI_BLIP_TYPE(Ped ped, int type) { invoke<Void>(0xE52B8E7F85D39A08, ped, type); } // 0xE52B8E7F85D39A08 0xD8E31B1A
	...
	inline void _IS_AI_BLIP_ALWAYS_SHOWN(Ped ped, BOOL flag) { invoke<Void>(0x0C4BBF625CA98C4E, ped, flag); } // 0x0C4BBF625CA98C4E 0xFFDF46F0
...
namespace GRAPHICS
{
	...
	inline void _DRAW_SPHERE(float x, float y, float z, float radius, int r, int g, int b, float opacity) { invoke<Void>(0x799017F9E3B10112, x, y, z, radius, r, g, b, opacity); }
	...
	inline void _0x23BA6B0C2AD7B0D3(BOOL toggle) { invoke<Void>(0x23BA6B0C2AD7B0D3, toggle); } // 0x23BA6B0C2AD7B0D3 0xC44C2F44
	inline BOOL _0x1DD2139A9A20DCE8() { return invoke<BOOL>(0x1DD2139A9A20DCE8); } // 0x1DD2139A9A20DCE8 0xBA9AD458
	inline int _0x90A78ECAA4E78453() { return invoke<int>(0x90A78ECAA4E78453); } // 0x90A78ECAA4E78453 0xADBBA287
	inline void _0x0A46AF8A78DC5E0A() { invoke<Void>(0x0A46AF8A78DC5E0A); } // 0x0A46AF8A78DC5E0A 0x9E553002
	inline BOOL _0x4862437A486F91B0(const char* p0, Any* p1, Any* p2, BOOL p3) { return invoke<BOOL>(0x4862437A486F91B0, p0, p1, p2, p3); } // 0x4862437A486F91B0 0x56C1E488
	inline int _0x1670F8D05056F257(Any p0) { return invoke<int>(0x1670F8D05056F257, p0); } // 0x1670F8D05056F257 0x226B08EA
	inline BOOL _0x7FA5D82B8F58EC06() { return invoke<BOOL>(0x7FA5D82B8F58EC06); } // 0x7FA5D82B8F58EC06 0x1F3CADB0
	inline int _0x5B0316762AFD4A64() { return invoke<int>(0x5B0316762AFD4A64); } // 0x5B0316762AFD4A64 0xA9DC8558
	inline void _0x346EF3ECAAAB149E() { invoke<Void>(0x346EF3ECAAAB149E); } // 0x346EF3ECAAAB149E 0x88EAF398
	inline BOOL _0xA67C35C56EB1BD9D() { return invoke<BOOL>(0xA67C35C56EB1BD9D); } // 0xA67C35C56EB1BD9D 0x47B0C137
	inline int _0x0D6CA79EEEBD8CA3() { return invoke<int>(0x0D6CA79EEEBD8CA3); } // 0x0D6CA79EEEBD8CA3 0x65376C9B
	...
	inline BOOL _0x3DEC726C25A11BAC(int p0) { return invoke<BOOL>(0x3DEC726C25A11BAC, p0); } // 0x3DEC726C25A11BAC 0x3B15D33C
	inline int _0x0C0C4E81E1AC60A0() { return invoke<int>(0x0C0C4E81E1AC60A0); } // 0x0C0C4E81E1AC60A0 0xEC5D0317
	inline BOOL _0x759650634F07B6B4(int p0) { return invoke<BOOL>(0x759650634F07B6B4, p0); } // 0x759650634F07B6B4 0x25D569EB
	inline int _0xCB82A0BF0E3E3265(int p0) { return invoke<int>(0xCB82A0BF0E3E3265, p0); } // 0xCB82A0BF0E3E3265 0xCFCDC518
	...
	inline int _GET_MAXIMUM_NUMBER_OF_PHOTOS_2() { return invoke<int>(0xDC54A7AF8B3A14EF); } // 0xDC54A7AF8B3A14EF 0x239272BD
	inline int _GET_NUMBER_OF_PHOTOS() { return invoke<int>(0x473151EBC762C6DA); } // 0x473151EBC762C6DA 0x21DBF0C9
	inline BOOL _0x2A893980E96B659A(BOOL p0) { return invoke<BOOL>(0x2A893980E96B659A, p0); } // 0x2A893980E96B659A 0x199FABF0
	inline int _0xF5BED327CEA362B1(BOOL p0) { return invoke<int>(0xF5BED327CEA362B1, p0); } // 0xF5BED327CEA362B1 0x596B900D
	...
	inline int _GET_LIVEAREA_SOMETHING(Any p0) { return invoke<int>(0x40AFB081F8ADD4EE, p0); } // 0x40AFB081F8ADD4EE 0x762E5C5F
	...
	inline void _ENTITY_DESCRIPTION_TEXT(Entity entity) { invoke<Void>(0xDEADC0DEDEADC0DE, entity); } // 0xDEADC0DEDEADC0DE
	...
	inline void _SET_CHECKPOINT_ICON_HEIGHT(int checkpoint, float iconHeight) { invoke<Void>(0x4B5B4DA5D79F1943, checkpoint, iconHeight); } // 0x4B5B4DA5D79F1943 0x80151CCF
	...
	inline void REQUEST_STREAMED_TEXTURE_DICT(const char* textureDict, BOOL unused) { invoke<Void>(0xDFA2EF8E04127DD5, textureDict, unused); } // 0xDFA2EF8E04127DD5 0x4C9B035F
	...
	inline void SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(BOOL p0) { invoke<Void>(0xC6372ECD45D73BCD, p0); } // 0xC6372ECD45D73BCD 0xF8FBCC25
	inline void _SET_UI_LAYER(int layer) { invoke<Void>(0x61BB1D9B3A95D802, layer); } // 0x61BB1D9B3A95D802 0xADF81D24
	inline void SET_SCRIPT_GFX_ALIGN(int x, int y) { invoke<Void>(0xB8A850F20A067EB6, x, y); } // 0xB8A850F20A067EB6 0x228A2598
	inline void RESET_SCRIPT_GFX_ALIGN() { invoke<Void>(0xE3A3DB414A373DAB); } // 0xE3A3DB414A373DAB 0x3FE33BD6
	...
	inline void _0x6DD8F5AA635EB4B2(float p0, float p1, float* p2, float* p3) { invoke<Void>(0x6DD8F5AA635EB4B2, p0, p1, p2, p3); } // 0x6DD8F5AA635EB4B2
	...
	inline void SET_ARTIFICIAL_LIGHTS_STATE(BOOL state) { invoke<Void>(0x1268615ACE24D504, state); } // 0x1268615ACE24D504 0xAA2A0EAF
	inline void _0xC35A6D07C93802B2() { invoke<Void>(0xC35A6D07C93802B2); } // 0xC35A6D07C93802B2
	inline int CREATE_TRACKED_POINT() { return invoke<int>(0xE2C9439ED45DEA60); } // 0xE2C9439ED45DEA60 0x3129C31A
	inline void SET_TRACKED_POINT_INFO(int point, float x, float y, float z, float radius) { invoke<Void>(0x164ECBB3CF750CB0, point, x, y, z, radius); } // 0x164ECBB3CF750CB0 0x28689AA4
	inline BOOL IS_TRACKED_POINT_VISIBLE(int point) { return invoke<BOOL>(0xC45CCDAAC9221CA8, point); } // 0xC45CCDAAC9221CA8 0x0BFC4F64
	inline void DESTROY_TRACKED_POINT(int point) { invoke<Void>(0xB25DC90BAD56CA42, point); } // 0xB25DC90BAD56CA42 0x14AC675F
	...
	inline void _0x6D955F6A9E0295B1(float x, float y, float z, float p3, float p4, float p5, float p6) { invoke<Void>(0x6D955F6A9E0295B1, x, y, z, p3, p4, p5, p6); } // 0x6D955F6A9E0295B1
	...
	inline void _0xD2936CAB8B58FCBD(int p0, BOOL p1, float x, float y, float z, float p5, BOOL p6, BOOL p7) { invoke<Void>(0xD2936CAB8B58FCBD, p0, p1, x, y, z, p5, p6, p7); } // 0xD2936CAB8B58FCBD
	...
	inline void _SET_UNK_TIMECYCLE_MODIFIER(int unk) { invoke<Void>(0xE3E2C1B4C59DBC77, unk); } // 0xE3E2C1B4C59DBC77 0xD8CC7221
	...
	inline void _TOGGLE_PAUSE_RENDER_PHASES(BOOL toggle) { invoke<Void>(0xDFC252D8A3E15AB7, toggle); } // 0xDFC252D8A3E15AB7 0x30ADE541
	...
	inline BOOL START_NETWORKED_PARTICLE_FX_NON_LOOPED_AT_COORD(const char* effectName, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0xF56B8137DF10135D, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0xF56B8137DF10135D 0x633F8C48
	...
	inline void SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(int ptfxHandle, float dist) { invoke<Void>(0xDCB194B85EF7B541, ptfxHandle, dist); } // 0xDCB194B85EF7B541 0x233DE879
	...
	inline void USE_PARTICLE_FX_ASSET(const char* name) { invoke<Void>(0x6C38AF3693A69A91, name); } // 0x6C38AF3693A69A91 0x9C720B61
	...
	inline void WASH_DECALS_IN_RANGE(float x, float y, float z, float radius, float intensity) { invoke<Void>(0x9C30613D50A6ADEF, x, y, z, radius, intensity); } // 0x9C30613D50A6ADEF 0xDEECBC57
	...
	inline void _START_PETROL_TRAIL_DECALS(float p0) { invoke<Void>(0x99AC7F0D8B9C893D, p0); } // 0x99AC7F0D8B9C893D 0xE3938B0B
	...
	inline void _END_PETROL_TRAIL_DECALS() { invoke<Void>(0x0A123435A26C36CD); } // 0x0A123435A26C36CD 0xCCCA6855
	inline void REMOVE_DECAL(Object decal) { invoke<Void>(0xED3F346429CCD659, decal); } // 0xED3F346429CCD659 0xA4363188
	inline BOOL IS_DECAL_ALIVE(Object decal) { return invoke<BOOL>(0xC694D74949CAFD0C, decal); } // 0xC694D74949CAFD0C 0xCDD4A61A
	...
	inline void _OVERRIDE_DECAL_TEXTURE(int decalType, const char* textureDict, const char* textureName) { invoke<Void>(0x8A35C742130C6080, decalType, textureDict, textureName); } // 0x8A35C742130C6080 0x335695CF
	inline void _0xB7ED70C49521A61D(int decalType) { invoke<Void>(0xB7ED70C49521A61D, decalType); } // 0xB7ED70C49521A61D 0x7B786555
	inline void MOVE_VEHICLE_DECALS(Vehicle vehicle1, Vehicle vehicle2) { invoke<Void>(0x84C8D7C2D30D3280, vehicle1, vehicle2); } // 0x84C8D7C2D30D3280 0xCE9E6CF2
	...
	inline BOOL _DOES_VEHICLE_HAVE_DECAL(Vehicle vehicle, int decalIndex) { return invoke<BOOL>(0x060D935D3981A275, vehicle, decalIndex); } // 0x060D935D3981A275 0x6D58F73B
	...
	inline void _PRESET_INTERIOR_AMBIENT_CACHE(const char* tcModifierName) { invoke<Void>(0xD7021272EB0A451E, tcModifierName); } // 0xD7021272EB0A451E
	...
	inline void _SET_TIMECYCLE_MODIFIER2(const char* p0) { invoke<Void>(0x5096FD9CCB49056D, p0); } // 0x5096FD9CCB49056D 0x908A335E
	...
	inline BOOL _HAS_NAMED_SCALEFORM_MOVIE_LOADED(const char* scaleformName) { return invoke<BOOL>(0x0C1C5D756FB5F337, scaleformName); } // 0x0C1C5D756FB5F337
	...
	inline BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_HUD_COMPONENT(int hudComponent, const char* functionName) { return invoke<BOOL>(0x98C494FD5BDFBFD5, hudComponent, functionName); } // 0x98C494FD5BDFBFD5 0x5D66CE1E
	...
	inline BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_N(const char* functionName) { return invoke<BOOL>(0xAB58C27C2E6123C6, functionName); } // 0xAB58C27C2E6123C6 0xF6015178
	inline BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_V(const char* functionName) { return invoke<BOOL>(0xB9449845F73F5E9C, functionName); } // 0xB9449845F73F5E9C 0x5E219B67
	inline void END_SCALEFORM_MOVIE_METHOD() { invoke<Void>(0xC6796A8FFA375E53); } // 0xC6796A8FFA375E53 0x02DBF2D7
	inline int _END_SCALEFORM_MOVIE_METHOD_RETURN() { return invoke<int>(0xC50AA39A577AF886); } // 0xC50AA39A577AF886 0x2F38B526
	inline BOOL IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(int method_return) { return invoke<BOOL>(0x768FF8961BA904D6, method_return); } // 0x768FF8961BA904D6 0x5CD7C3C0
	inline int _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(int method_return) { return invoke<int>(0x2DE7EFA66B906036, method_return); } // 0x2DE7EFA66B906036 0x2CFB0E6D
	inline const char* SITTING_TV(int method_return) { return invoke<const char*>(0xE1E258829A885245, method_return); } // 0xE1E258829A885245 0x516862EB
	...
	inline void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING(const char* value) { invoke<Void>(0xBA7148484BD90365, value); } // 0xBA7148484BD90365 0x4DAAD55B
	inline void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(const char* button) { invoke<Void>(0xE83A3E3557A56640, button); } // 0xE83A3E3557A56640 0xCCBF0334
	inline BOOL _0x5E657EF1099EDD65(int p0) { return invoke<BOOL>(0x5E657EF1099EDD65, p0); } // 0x5E657EF1099EDD65 0x91A081A1
	inline void _0xEC52C631A1831C03(int p0) { invoke<Void>(0xEC52C631A1831C03, p0); } // 0xEC52C631A1831C03 0x83A9811D
	inline void _REQUEST_SCALEFORM_SCRIPT_HUD_MOVIE(int hudComponent) { invoke<Void>(0x9304881D6F6537EA, hudComponent); } // 0x9304881D6F6537EA 0x7AF85862
	...
	inline void SET_TV_CHANNEL_PLAYLIST(int channel, const char* playlist, BOOL fromBeginning) { invoke<Void>(0xF7B38B8305F1FE8B, channel, playlist, fromBeginning); } // 0xF7B38B8305F1FE8B 0xB262DE67
	...
	inline BOOL _IS_TV_PLAYLIST_ITEM_PLAYING(Hash videoClip) { return invoke<BOOL>(0x0AD973CA1E077B60, videoClip); } // 0x0AD973CA1E077B60 0x4D1EB0FB
	...
	inline BOOL _DRAW_SHOWROOM(const char* p0, Ped ped, int p2, float posX, float posY, float posZ) { return invoke<BOOL>(0x98C4FE6EC34154CA, p0, ped, p2, posX, posY, posZ); } // 0x98C4FE6EC34154CA 0x9A0E3BFE
	...
	inline void ANIMPOSTFX_PLAY(const char* effectName, int duration, BOOL looped) { invoke<Void>(0x2206BF9A37B7F724, effectName, duration, looped); } // 0x2206BF9A37B7F724 0x1D980479
	inline void ANIMPOSTFX_STOP(const char* effectName) { invoke<Void>(0x068E835A1D0DC0E3, effectName); } // 0x068E835A1D0DC0E3 0x06BB5CDA
	inline BOOL ANIMPOSTFX_IS_RUNNING(const char* effectName) { return invoke<BOOL>(0x36AD3E690DA5ACEB, effectName); } // 0x36AD3E690DA5ACEB 0x089D5921
	inline void ANIMPOSTFX_STOP_ALL() { invoke<Void>(0xB4EDDC19532BFB85); } // 0xB4EDDC19532BFB85 0x4E6D875B
	inline void _SWITCH_HUD(const char* graphicsName) { invoke<Void>(0xD2209BE128B5418C, graphicsName); } // 0xD2209BE128B5418C
}
...
namespace STATS
{
	...
	inline BOOL STAT_SET_USER_ID(Hash playerName, const char* value, BOOL save) { return invoke<BOOL>(0x8CDDF1E452BABE11, playerName, value, save); } // 0x8CDDF1E452BABE11 0xDBE78ED7
	...
	inline BOOL STAT_GET_POS(Hash statHash, float* x, float* y, float* z, int p4) { return invoke<BOOL>(0x350F82CCB186AA1B, statHash, x, y, z, p4); } // 0x350F82CCB186AA1B 0xC846ECCE
	inline BOOL STAT_GET_MASKED_INT(Hash statHash, int* outValue, Any p2, Any p3, Any p4) { return invoke<BOOL>(0x655185A06D9EEAAB, statHash, outValue, p2, p3, p4); } // 0x655185A06D9EEAAB 0xE9D9B70F
	inline const char* STAT_GET_USER_ID(Any* playerName) { return invoke<const char*>(0x2365C388E393BBE2, playerName); } // 0x2365C388E393BBE2 0xE2E8B6BA
	...
	inline void _0x26D7399B9587FE89(int const characterIndex) { invoke<Void>(0x26D7399B9587FE89, characterIndex); } // 0x26D7399B9587FE89 0x343B27E2
	...
	inline void STAT_SET_PROFILE_SETTING_VALUE(int profileSetting, int value) { invoke<Void>(0x68F01422BE1D838F, profileSetting, value); } // 0x68F01422BE1D838F 0x24DD4929
	...
	inline Hash _GET_PSTAT_BOOL_HASH(int index, BOOL spStat, BOOL const charStat, int const character) { return invoke<Hash>(0x80C75307B1C42837, index, spStat, charStat, character); } // 0x80C75307B1C42837 0xB5BF87B2
	inline Hash _GET_PSTAT_INT_HASH(int index, BOOL spStat, BOOL const charStat, int const character) { return invoke<Hash>(0x61E111E323419E07, index, spStat, charStat, character); } // 0x61E111E323419E07 0x1F938864
	inline Hash _GET_TUPSTAT_BOOL_HASH(int index, BOOL spStat, BOOL const charStat, int const character) { return invoke<Hash>(0xC4BB08EE7907471E, index, spStat, charStat, character); } // 0xC4BB08EE7907471E 0x3F8E893B
	inline Hash _GET_TUPSTAT_INT_HASH(int index, BOOL spStat, BOOL const charStat, int const character) { return invoke<Hash>(0xD16C2AD6B8E32854, index, spStat, charStat, character); } // 0xD16C2AD6B8E32854 0xFB93C5A2
	inline Hash _GET_NGSTAT_BOOL_HASH(int index, BOOL spStat, BOOL const charStat, int const character, const char* section) { return invoke<Hash>(0xBA52FF538ED2BC71, index, spStat, charStat, character, section); } // 0xBA52FF538ED2BC71
	inline Hash _GET_NGSTAT_INT_HASH(int index, BOOL spStat, BOOL const charStat, int const character, const char* section) { return invoke<Hash>(0x2B4CDCA6F07FF3DA, index, spStat, charStat, character, section); } // 0x2B4CDCA6F07FF3DA
	...
	inline void PLAYSTATS_AWARD_XP(int xp, Hash hash1, Hash hash2) { invoke<Void>(0x46F917F6B4128FE4, xp, hash1, hash2); } // 0x46F917F6B4128FE4 0x8770017B
	inline void PLAYSTATS_RANK_UP(Player player) { invoke<Void>(0xC7F2DE41D102BFB4, player); } // 0xC7F2DE41D102BFB4 0x56AFB9F5
	...
	inline void PLAYSTATS_RANDOM_MISSION_DONE(const char* name, Any p1, Any p2, Any p3) { invoke<Void>(0x71862B1D855F32E1, name, p1, p2, p3); } // 0x71862B1D855F32E1 0xAC2C7C63
	inline void PLAYSTATS_ROS_BET(int amount, int act, Player player, float cm) { invoke<Void>(0x121FB4DDDC2D5291, amount, act, player, cm); } // 0x121FB4DDDC2D5291 0x413539BC
	...
	inline void PLAYSTATS_ACQUIRED_HIDDEN_PACKAGE(Any p0) { invoke<Void>(0x79AB33F0FBFAC40C, p0); } // 0x79AB33F0FBFAC40C 0x8D5C7B37
	...
	inline void PLAYSTATS_QUICKFIX_TOOL(int element, const char* item) { invoke<Void>(0x90D0622866E80445, element, item); } // 0x90D0622866E80445 0x66FEB701
	inline void PLAYSTATS_IDLE_KICK(int time) { invoke<Void>(0x5DA3A8DE8CB6226F, time); } // 0x5DA3A8DE8CB6226F 0x9E2B9522
	...
	inline void _0x11FF1C80276097ED(const char* p0, Any p1, Any p2) { invoke<Void>(0x11FF1C80276097ED, p0, p1, p2); } // 0x11FF1C80276097ED 0x4AC39C6C
	...
	inline void _SET_PROFILE_SETTING_933(int value) { invoke<Void>(0xF1A1803D3476F215, value); } // 0xF1A1803D3476F215 0xA3DAC790
	inline void _SET_PROFILE_SETTING_934(int value) { invoke<Void>(0x38BAAA5DD4C9D19F, value); } // 0x38BAAA5DD4C9D19F 0x726FAE66
	inline void _SET_PROFILE_SETTING_935(int value) { invoke<Void>(0x55384438FC55AD8E, value); } // 0x55384438FC55AD8E 0xF03895A4
	...
	inline void _LEADERBOARDS_DEATHS(Hash statName, float value) { invoke<Void>(0x428EAF89E24F6C36, statName, value); } // 0x428EAF89E24F6C36 0xEE292B91
	inline void _0x047CBED6F6F8B63C() { invoke<Void>(0x047CBED6F6F8B63C); } // 0x047CBED6F6F8B63C 0xA063CABD
	inline BOOL _LEADERBOARDS2_WRITE_DATA_EX(Any* p0, Any* p1) { return invoke<BOOL>(0xC980E62E33DF1D5C, p0, p1); } // 0xC980E62E33DF1D5C 0x62C19A3D
	...
	inline void _UNLOCK_EXCLUS_CONTENT(Any bitset) { invoke<Void>(0xDAC073C7901F9E15, bitset); } // 0xDAC073C7901F9E15
	inline void _SET_PROFILE_SETTING_501(Any p0) { invoke<Void>(0xF6792800AC95350D, p0); } // 0xF6792800AC95350D
}
...
namespace BRAIN
{
	...
	inline void _STOP_ALL_SCRIPTS() { invoke<Void>(0x0B40ED49D7D6FF84); } // 0x0B40ED49D7D6FF84 0x19B27825
	inline void _FLUSH_ALL_SCRIPTS() { invoke<Void>(0x4D953DF78EBF8158); } // 0x4D953DF78EBF8158 0xF3A3AB08
...
namespace MOBILE
{
	inline void CREATE_MOBILE_PHONE(int p4) { invoke<Void>(0xA4E8E696C532FBC7, p4); } // 0xA4E8E696C532FBC7 0x5BBC5E23
	...
	inline void GET_MOBILE_PHONE_ROTATION(Vector3* rotation, int p1) { invoke<Void>(0x1CEFB61F193070AE, rotation, p1); } // 0x1CEFB61F193070AE 0x17A29F23
	...
	inline void CELL_CAM_ACTIVATE(BOOL toggle, BOOL p1) { invoke<Void>(0xFDE8F069C542D126, toggle, p1); } // 0xFDE8F069C542D126 0x234C1AE9
...
namespace PATHFIND
{
	...
	inline BOOL GET_CLOSEST_MAJOR_VEHICLE_NODE(float x, float y, float z, Vector3* outPosition, float p5, int p6) { return invoke<BOOL>(0x2EABE3B06F58C1BE, x, y, z, outPosition, p5, p6); } // 0x2EABE3B06F58C1BE 0x04B5F15B
	...
	inline BOOL GET_NTH_CLOSEST_VEHICLE_NODE(float x, float y, float z, int nthClosest, Vector3* outPosition, BOOL p6, float p7, float p8) { return invoke<BOOL>(0xE50E52416CCF948B, x, y, z, nthClosest, outPosition, p6, p7, p8); } // 0xE50E52416CCF948B 0xF125BFCC
	...
	inline BOOL GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* outHeading, int* outInt, int p6, float p7, float p8) { return invoke<BOOL>(0x80CA6A8B6C094CC4, x, y, z, nthClosest, outPosition, outHeading, outInt, p6, p7, p8); } // 0x80CA6A8B6C094CC4 0x7349C856
	inline Any GET_NTH_CLOSEST_VEHICLE_NODE_ID_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* outHeading, int nodeType, float p7, float p8) { return invoke<Any>(0x6448050E9C2A7207, x, y, z, nthClosest, outPosition, outHeading, nodeType, p7, p8); } // 0x6448050E9C2A7207 0xC1AEB88D
	...
	inline Any GET_CLOSEST_ROAD(float posX, float posY, float posZ, float p3, int p4, Vector3* p5, Vector3* p6, int* p7, int* p8, float* p9, int p10) { return invoke<Any>(0x132F52BBA570FE92, posX, posY, posZ, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x132F52BBA570FE92 0x567B0E11
	...
	inline void _UNLOAD_ALL_PATH_NODES(BOOL keepInMemory) { invoke<Void>(0x228E5C6AD4D74BFD, keepInMemory); } // 0x228E5C6AD4D74BFD 0xD6A3B458
	...
	inline int GENERATE_DIRECTIONS_TO_COORD(float x, float y, float z, BOOL p3, float* direction, float* vehicle, float* distToNxJunction) { return invoke<int>(0xF90125F1F79ECDF8, x, y, z, p3, direction, vehicle, distToNxJunction); } // 0xF90125F1F79ECDF8 0xED35C094
	...
	inline void SET_GPS_DISABLED_ZONE(float x1, float y1, float z1, float x2, float y2, float z2) { invoke<Void>(0xDC20483CD3DD5201, x1, y1, z1, x2, y2, z2); } // 0xDC20483CD3DD5201 0x720B8073
	...
	inline void DISABLE_NAVMESH_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2, BOOL disable) { invoke<Void>(0x4C8872D8CDBE1B8B, x1, y1, z1, x2, y2, z2, disable); } // 0x4C8872D8CDBE1B8B 0x6E37F132
...
namespace CONTROLS
{
	...
	inline BOOL IS_CONTROL_PRESSED(int inputGroup, int contorl) { return invoke<BOOL>(0xF3A21BCD95725A4A, inputGroup, contorl); } // 0xF3A21BCD95725A4A 0x517A4384
	...
	inline BOOL _IS_LOOK_NOT_INVERTED() { return invoke<BOOL>(0xE1615EC03B3BB4FD); } // 0xE1615EC03B3BB4FD
...
namespace DATAFILE
{
	inline void _0xAD6875BBC0FC899C(Blip x) { invoke<Void>(0xAD6875BBC0FC899C, x); } // 0xAD6875BBC0FC899C 0x621388FF
	...
	inline BOOL _SEND_UGC_DATAFILE(int p0) { return invoke<BOOL>(0xA69AC4ADE82B57A4, p0); } // 0xA69AC4ADE82B57A4 0xE8D56DA2
	...
	inline Any* _OBJECT_VALUE_GET_OBJECT(Any* sCloudFile, const char* key) { return invoke<Any*>(0xB6B9DDC412FCEEE2, sCloudFile, key); } // 0xB6B9DDC412FCEEE2 0xC9C13D8D
...
namespace FIRE
{
	inline Hash START_SCRIPT_FIRE(float X, float Y, float Z, int maxChildren, BOOL isGasFire) { return invoke<Hash>(0x6B83617E04503888, X, Y, Z, maxChildren, isGasFire); } // 0x6B83617E04503888 0xE7529357
	inline void REMOVE_SCRIPT_FIRE(int fireHandle) { invoke<Void>(0x7FF548385680673F, fireHandle); } // 0x7FF548385680673F 0x6B21FE26
	inline Ped START_ENTITY_FIRE(Ped entity) { return invoke<Ped>(0xF6A9D9708F6F23DF, entity); } // 0xF6A9D9708F6F23DF 0x8928428E
	...
	inline int _GET_EXPLOSIONS_IN_AREA(int explosionType, float x1, float y1, float z1, float x2, float y2, float z2) { return invoke<int>(0x6070104B699B2EF4, explosionType, x1, y1, z1, x2, y2, z2); } // 0x6070104B699B2EF4
...
namespace ROPE
{
	...
	inline void _HIDE_ROPE(Object rope, int value) { invoke<Void>(0xDC57A637A20006ED, rope, value); } // 0xDC57A637A20006ED 0x80DB77A7
	inline void _0x36CCB9BE67B970FD(Object rope, BOOL p1) { invoke<Void>(0x36CCB9BE67B970FD, rope, p1); } // 0x36CCB9BE67B970FD 0xC67D5CF6
	inline BOOL _0x84DE3B5FB3E666F0(Object rope) { return invoke<BOOL>(0x84DE3B5FB3E666F0, rope); } // 0x84DE3B5FB3E666F0 0x7A18BB9C
	...
	inline void _0xBC0CE682D4D05650(Object rope, int unk, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4) { invoke<Void>(0xBC0CE682D4D05650, rope, unk, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4); } // 0xBC0CE682D4D05650 0x106BA127
	...
	inline void ROPE_RESET_LENGTH(Object rope, float length) { invoke<Void>(0xC16DE94D9BEA14A0, rope, length); } // 0xC16DE94D9BEA14A0 0xC8A423A3
	...
	inline void SET_DAMPING(Object ropeorobject, int vertex, float value) { invoke<Void>(0xEEA3B200A6FEB65B, ropeorobject, vertex, value); } // 0xEEA3B200A6FEB65B 0xCFB37773
	...
	inline void BREAK_ENTITY_GLASS(Object object, float posX, float posY, float posZ, float p4, float offsetX, float offsetY, float offsetZ, float p8, int p9, BOOL p10) { invoke<Void>(0x2E648D16F6E308F3, object, posX, posY, posZ, p4, offsetX, offsetY, offsetZ, p8, p9, p10); } // 0x2E648D16F6E308F3 0xD0E0402F
	...
	inline void _0xCC6E963682533882(Object object) { invoke<Void>(0xCC6E963682533882, object); } // 0xCC6E963682533882
...
namespace WATER
{
	...
	inline BOOL GET_WATER_HEIGHT_NO_WAVES(float B, float y, float z, float* height) { return invoke<BOOL>(0x8EE6B53CE13A9794, B, y, z, height); } // 0x8EE6B53CE13A9794 0x262017F8
	...
	inline int TEST_PROBE_AGAINST_ALL_WATER(float x1, float y1, float z1, float x2, float y2, float z2, int type, Vector3* result) { return invoke<int>(0x8974647ED222EA5F, x1, y1, z1, x2, y2, z2, type, result); } // 0x8974647ED222EA5F 0x4A962D55
	inline BOOL TEST_VERTICAL_PROBE_AGAINST_ALL_WATER(float x, float y, float z, float p3, float* height) { return invoke<BOOL>(0x2B3451FA1E3142E2, x, y, z, p3, height); } // 0x2B3451FA1E3142E2 0x4C71D143
	...
	inline int _ADD_CURRENT_RISE(float xLow, float yLow, float xHigh, float yHigh, float height) { return invoke<int>(0xFDBF4CDBC07E1706, xLow, yLow, xHigh, yHigh, height); } // 0xFDBF4CDBC07E1706
	inline void _REMOVE_CURRENT_RISE(int riseHandle) { invoke<Void>(0xB1252E3E59A82AAF, riseHandle); } // 0xB1252E3E59A82AAF
...
{
	inline int START_SHAPE_TEST_LOS_PROBE(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity ent, int p8) { return invoke<int>(0x7EE9F5D83DD4F90E, x1, y1, z1, x2, y2, z2, flags, ent, p8); } // 0x7EE9F5D83DD4F90E 0xEFAF4BA6
	...
	inline void _SHAPE_TEST_RESULT_ENTITY(Hash entityHit) { invoke<Void>(0x2B3334BCA57CD799, entityHit); } // 0x2B3334BCA57CD799 0xEC2AAF06
}
...
namespace NETWORK
{
	...
	inline BOOL _0xEBCAB9E5048434F4() { return invoke<BOOL>(0xEBCAB9E5048434F4); } // 0xEBCAB9E5048434F4
	inline BOOL _0x74FB3E29E6D10FA9() { return invoke<BOOL>(0x74FB3E29E6D10FA9); } // 0x74FB3E29E6D10FA9
	...
	inline BOOL _NETWORK_IS_NP_AVAILABLE() { return invoke<BOOL>(0x8D11E61A4ABF49CC); } // 0x8D11E61A4ABF49CC
	...
	inline BOOL _NETWORK_HAS_RESTRICTED_PROFILE() { return invoke<BOOL>(0x1353F87E89946207); } // 0x1353F87E89946207
	inline Any _72D918C99BCACC54(Any p0) { return invoke<Any>(0x72D918C99BCACC54, p0); } // 0x72D918C99BCACC54 0x1F88819D
	...
	inline BOOL NETWORK_SESSION_GET_KICK_VOTE(Player player) { return invoke<BOOL>(0xD6D09A6F32F49EF1, player); } // 0xD6D09A6F32F49EF1 0x8A559D26
	...
	inline void _NETWORK_SCTV_SLOTS(int p0) { invoke<Void>(0x49EC8030F5015F8B, p0); } // 0x49EC8030F5015F8B 0x3C3E2AB6
	...
	inline BOOL NETWORK_X_AFFECTS_GAMERS(int crewId) { return invoke<BOOL>(0xE532D6811B3A4D2A, crewId); } // 0xE532D6811B3A4D2A 0x7771AB83
	inline BOOL NETWORK_FIND_MATCHED_GAMERS(int attribute, float p1, float lowerLimit, float upperLimit) { return invoke<BOOL>(0xF7B2CFDE5C9F700D, attribute, p1, lowerLimit, upperLimit); } // 0xF7B2CFDE5C9F700D 0xA13045D4
	inline BOOL NETWORK_IS_FINDING_GAMERS() { return invoke<BOOL>(0xDDDF64C91BFCF0AA); } // 0xDDDF64C91BFCF0AA 0xA6DAA79F
	inline BOOL _0xF9B83B77929D8863() { return invoke<BOOL>(0xF9B83B77929D8863); } // 0xF9B83B77929D8863 0xBEDC4503
	...
	inline void _CLEAR_NET_FUNC_DATA() { invoke<Void>(0x86E0660E4F5C956D); } // 0x86E0660E4F5C956D 0x3F7EDBBD
	...
	inline void _SERVER_HANDLER() { invoke<Void>(0xF814FEC6A19FD6E0); } // 0xF814FEC6A19FD6E0 0x32B7A076
	...
	inline BOOL _NETWORK_IS_CHAT_RESTRICTED() { return invoke<BOOL>(0x74698374C45701D2); } // 0x74698374C45701D2 0x70ED476A
	inline void _NETWORK_SET_CHAT_RESTRICTION_THIS_FRAME() { invoke<Void>(0x140E6A44870A11CE); } // 0x140E6A44870A11CE 0x50507BED
	...
	inline BOOL NETWORK_SESSION_IS_VISIBLE() { return invoke<BOOL>(0xBA416D68C631496A); } // 0xBA416D68C631496A 0x4977AC28
	inline void NETWORK_SESSION_BLOCK_JOIN_REQUESTS(BOOL toggle) { invoke<Void>(0xA73667484D7037C3, toggle); } // 0xA73667484D7037C3 0xE6EEF8AF
	...
	inline int _0x53AFD64C6758F2F9() { return invoke<int>(0x53AFD64C6758F2F9); } // 0x53AFD64C6758F2F9
	...
	inline void NETWORK_SESSION_VOICE_CONNECT_TO_PLAYER(Any* p0) { invoke<Void>(0xABD5E88B8A2D3DB2, p0); } // 0xABD5E88B8A2D3DB2 0x9DFD89E6
	...
	inline BOOL NETWORK_IS_ACTIVITY_SPECTATOR() { return invoke<BOOL>(0x12103B9E0C9F92FB); } // 0x12103B9E0C9F92FB 0xAF329720
	...
	inline Any NETWORK_HOST_TRANSITION(Any p0, int playerCount, Any p2, Hash jobHash, Any p4, Any p5) { return invoke<Any>(0xA60BB5CE242BB254, p0, playerCount, p2, jobHash, p4, p5); } // 0xA60BB5CE242BB254 0x146764FB
	...
	inline BOOL NETWORK_DO_TRANSITION_TO_FREEMODE(Any* netHandle, Any netHandleIndex, BOOL p2, int players, BOOL p4) { return invoke<BOOL>(0x3AAD8B2FCA1E289F, netHandle, netHandleIndex, p2, players, p4); } // 0x3AAD8B2FCA1E289F 0xC7CB8ADF
	inline BOOL NETWORK_DO_TRANSITION_TO_NEW_FREEMODE(int* networkHandle, Any* p1, int players, BOOL p3, BOOL p4, BOOL p5) { return invoke<BOOL>(0x9E80A5BA8109F974, networkHandle, p1, players, p3, p4, p5); } // 0x9E80A5BA8109F974 0xAD13375E
	...
	inline void _NETWORK_BLOCK_INVITES_2(BOOL p0) { invoke<Void>(0x4A9FDE3A5A6D0437, p0); } // 0x4A9FDE3A5A6D0437 0x18F03AFD
	...
	inline Any _0x44B37CDCAE765AAE(Player p0, BOOL* p1) { return invoke<Any>(0x44B37CDCAE765AAE, p0, p1); } // 0x44B37CDCAE765AAE
	...
	inline BOOL _NETWORK_CHECK_DATA_MANAGER_FOR_HANDLE(Any* p0) { return invoke<BOOL>(0x796A87B3B68D1F3D, p0); } // 0x796A87B3B68D1F3D
	...
	inline void _MARK_SESSION_AS_JOINED() { invoke<Void>(0x25D990F8E0E3F13C); } // 0x25D990F8E0E3F13C
	inline void _0x77FADDCBE3499DF7(Any p0) { invoke<Void>(0x77FADDCBE3499DF7, p0); } // 0x77FADDCBE3499DF7 0x8179C48A
	inline void _NETWORK_SET_RANDOM_INT_SEED(int seed) { invoke<Void>(0xF1B84178F8674195, seed); } // 0xF1B84178F8674195 0x41702C8A
	...
	inline BOOL NETWORK_PLAYER_GET_CHEATER_REASON() { return invoke<BOOL>(0x172F75B6EE2233BA); } // 0x172F75B6EE2233BA 0x1720ABA6
	inline BOOL NETWORK_PLAYER_IS_BADSPORT() { return invoke<BOOL>(0x19D8DA0E5A68045A); } // 0x19D8DA0E5A68045A 0xA19708E3
	inline BOOL GET_PLAYER_STAT_STARS_VISIBILITY(Player player, int p1, Hash scriptHash) { return invoke<BOOL>(0x46FB3ED415C7641C, player, p1, scriptHash); } // 0x46FB3ED415C7641C 0xF9A51B92
	inline BOOL BAD_SPORT_PLAYER_LEFT_DETECTED(int* networkHandle, int p1, int p2) { return invoke<BOOL>(0xEC5E3AF5289DCA81, networkHandle, p1, p2); } // 0xEC5E3AF5289DCA81 0x4C2C6B6A
	inline void _0xE66C690248F11150(Entity p0, Any p1) { invoke<Void>(0xE66C690248F11150, p0, p1); } // 0xE66C690248F11150 0x4818ACD0
	inline void NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(int lobbySize, BOOL p1, int instanceId) { invoke<Void>(0x1CA59E306ECB80A5, lobbySize, p1, instanceId); } // 0x1CA59E306ECB80A5 0x470810ED
	inline BOOL _NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT_2(int numPlayers, BOOL p1, int instanceId) { return invoke<BOOL>(0xD1110739EEADB592, numPlayers, p1, instanceId); } // 0xD1110739EEADB592
	...
	inline void NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(int* vars, int sizeofVars) { invoke<Void>(0x3E9B2F01C50DF595, vars, sizeofVars); } // 0x3E9B2F01C50DF595 0xDAF3B0AE
	inline void NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(const char* vars, ScrHandle numVars) { invoke<Void>(0x3364AA97340CA215, vars, numVars); } // 0x3364AA97340CA215 0xBE3D32B4
	...
	inline BOOL NETWORK_IS_PLAYER_A_PARTICIPANT(Player playerId) { return invoke<BOOL>(0x3CA58F6CB7CBD784, playerId); } // 0x3CA58F6CB7CBD784 0xB08B6992
	...
	inline int NETWORK_GET_HOST_OF_SCRIPT(const char* scriptName, int instanceId, int positionHash) { return invoke<int>(0x1D6A14F1F9A736FC, scriptName, instanceId, positionHash); } // 0x1D6A14F1F9A736FC 0x9C95D0BB
	inline void NETWORK_SET_MISSION_FINISHED() { invoke<Void>(0x3B3D11CD9FFCDFC9); } // 0x3B3D11CD9FFCDFC9 0x3083FAD7
	inline BOOL NETWORK_IS_SCRIPT_ACTIVE(const char* scriptName, int instanceId, BOOL unk, int positionHash) { return invoke<BOOL>(0x9D40DF90FAD26098, scriptName, instanceId, unk, positionHash); } // 0x9D40DF90FAD26098 0x4A65250C
	...
	inline int _NETWORK_GET_PLAYER_PED_FROM_INDEX() { return invoke<int>(0x638A3A81733086DB); } // 0x638A3A81733086DB 0xDB8B5D71
	inline BOOL NETWORK_IS_PLAYER_A_PARTICIPANT_ON_SCRIPT(Player p0, Any* p1, Any p2) { return invoke<BOOL>(0x1AD5B71586B94820, p0, p1, p2); } // 0x1AD5B71586B94820 0xCEA55F4C
	...
	inline BOOL _NETWORK_GET_DESTROYER_OF_ENTITY(Any p0, Any p1, Hash* weaponHash) { return invoke<BOOL>(0x4CACA84440FA26F6, p0, p1, weaponHash); } // 0x4CACA84440FA26F6 0x28A45454
	...
	inline BOOL NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(int netId) { return invoke<BOOL>(0x18A47D074708FD68, netId); } // 0x18A47D074708FD68 0x1E2E3177
	...
	inline BOOL _NETWORK_IS_DOOR_NETWORKED(Hash doorHash) { return invoke<BOOL>(0xC01E93FAC20C3346, doorHash); } // 0xC01E93FAC20C3346
	...
	inline const char* NETWORK_PLAYER_GET_USERID(Player player, const char* userID) { return invoke<const char*>(0x4927FC39CD0869A0, player, userID); } // 0x4927FC39CD0869A0 0x4EC0D983
	...
	inline BOOL _NETWORK_PLAYER_IS_CHEATER(Player player) { return invoke<BOOL>(0x565E430DB3B05BEC, player); } // 0x565E430DB3B05BEC 0xD265B049
	...
	inline const char* NETWORK_GET_FRIEND_NAME(int friendIndex) { return invoke<const char*>(0xE11EBBB2A783FE8B, friendIndex); } // 0xE11EBBB2A783FE8B 0x97420B6D
	...
	inline BOOL _NETWORK_IS_FRIEND_HANDLE_ONLINE(int* networkHandle) { return invoke<BOOL>(0x87EB7A3FFCB314DB, networkHandle); } // 0x87EB7A3FFCB314DB
	...
	inline BOOL NETWORK_IS_PENDING_FRIEND(Any p0) { return invoke<BOOL>(0x0BE73DA6984A6E33, p0); } // 0x0BE73DA6984A6E33 0x5C85FF81
	inline BOOL NETWORK_IS_ADDING_FRIEND() { return invoke<BOOL>(0x6EA101606F6E4D81); } // 0x6EA101606F6E4D81 0xBB7EC8C4
	inline BOOL NETWORK_ADD_FRIEND(int* networkHandle, const char* message) { return invoke<BOOL>(0x8E02D73914064223, networkHandle, message); } // 0x8E02D73914064223 0x20E5B3EE
	...
	inline void _NETWORK_SET_PASSIVE_MODE(BOOL p0) { invoke<Void>(0x1B857666604B1A74, p0); } // 0x1B857666604B1A74
	...
	inline void _GET_PLAYER_WAYPOINT_COORDS(Player p0, float* p1, float* p2) { invoke<Void>(0xADB57E5B663CCA8B, p0, p1, p2); } // 0xADB57E5B663CCA8B 0x92268BB5
	...
	inline void NETWORK_SET_RICH_PRESENCE(int p0, Any p1, Any p2, Any p3) { invoke<Void>(0x1DCCACDCFC569362, p0, p1, p2, p3); } // 0x1DCCACDCFC569362 0x932A6CED
	inline void _NETWORK_SET_RICH_PRESENCE_2(int p0, const char* gxtLabel) { invoke<Void>(0x3E200C2BCF4164EB, p0, gxtLabel); } // 0x3E200C2BCF4164EB 0x017E6777
	...
	inline void _NETWORK_RESPAWN_PLAYER(Player player, BOOL p1) { invoke<Void>(0xBF22E0F32968E967, player, p1); } // 0xBF22E0F32968E967 0x22E03AD0
	inline void REMOVE_ALL_STICKY_BOMBS_FROM_ENTITY(Entity entity) { invoke<Void>(0x715135F4B82AC90D, entity); } // 0x715135F4B82AC90D 0xCEAE5AFC
	...
	inline BOOL _NETWORK_GET_PLAYER_CREW_EMBLEM_TXD_NAME(Player* player, Any* p1) { return invoke<BOOL>(0x5835D9CD92E83184, player, p1); } // 0x5835D9CD92E83184 0xBA672146
	...
	inline void _NETWORK_SET_NETWORK_ID_CAN_BE_SEEN(int netId, BOOL state) { invoke<Void>(0x3FA36981311FA4FF, netId, state); } // 0x3FA36981311FA4FF 0x00AE4E17
	inline BOOL _NETWORK_CAN_NETWORK_ID_BE_SEEN(int netId) { return invoke<BOOL>(0xA1607996431332DF, netId); } // 0xA1607996431332DF 0xEA5176C0
	...
	inline BOOL _0x631DC5DFF4B110E3(Player index) { return invoke<BOOL>(0x631DC5DFF4B110E3, index); } // 0x631DC5DFF4B110E3
	inline BOOL _0x422F32CC7E56ABAD(Vehicle vehicle) { return invoke<BOOL>(0x422F32CC7E56ABAD, vehicle); } // 0x422F32CC7E56ABAD
	...
	inline BOOL IS_SPHERE_VISIBLE_TO_PLAYER(Player player, float x, float y, float z, float scale) { return invoke<BOOL>(0xDC3A310219E5DA62, player, x, y, z, scale); } // 0xDC3A310219E5DA62 0xE9FCFB32
	...
	inline int GET_NUM_CREATED_MISSION_OBJECTS(BOOL p0) { return invoke<int>(0x12B6281B6C6706C0, p0); } // 0x12B6281B6C6706C0 0x603FA104
	inline int GET_NUM_CREATED_MISSION_PEDS(BOOL p0) { return invoke<int>(0xCB215C4B56A7FAE7, p0); } // 0xCB215C4B56A7FAE7 0xD8FEC4F8
	inline int GET_NUM_CREATED_MISSION_VEHICLES(BOOL p0) { return invoke<int>(0x0CD9AB83489430EA, p0); } // 0x0CD9AB83489430EA 0x20527695
	inline Any GET_MAX_NUM_NETWORK_OBJECTS() { return invoke<Any>(0xC7BE335216B5EC7C); } // 0xC7BE335216B5EC7C 0x8687E285
	...
	inline int _GET_NETWORK_TIME2() { return invoke<int>(0x89023FBBF9200E9F); } // 0x89023FBBF9200E9F 0x98AA48E5
	...
	inline void NETWORK_SET_IN_SPECTATOR_MODE_EXTENDED(BOOL toggle, Ped playerPed, BOOL p2) { invoke<Void>(0x419594E137637120, toggle, playerPed, p2); } // 0x419594E137637120 0x54058F5F
	...
	inline void _SET_NETWORK_OBJECT_NON_CONTACT(Object object, BOOL toggle) { invoke<Void>(0x6274C4712850841E, object, toggle); } // 0x6274C4712850841E 0xEA235081
	...
	inline BOOL NETWORK_START_RESPAWN_SEARCH_FOR_PLAYER(Player player, float p1, float p2, float p3, float p4, float p5, float p6, float p7, int flags) { return invoke<BOOL>(0x5A6FFA2433E2F14C, player, p1, p2, p3, p4, p5, p6, p7, flags); } // 0x5A6FFA2433E2F14C 0xC62E77B3
	inline BOOL NETWORK_START_RESPAWN_SEARCH_IN_ANGLED_AREA_FOR_PLAYER(Player player, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, int flags) { return invoke<BOOL>(0x4BA92A18502BCA61, player, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, flags); } // 0x4BA92A18502BCA61 0x74D6B13C
	inline Any _0x3C891A251567DFCE(Any* p0) { return invoke<Any>(0x3C891A251567DFCE, p0); } // 0x3C891A251567DFCE 0x90700C7D
	inline void NETWORK_CANCEL_RESPAWN_SEARCH() { invoke<Void>(0xFB8F2A6F3DF08CBE); } // 0xFB8F2A6F3DF08CBE 0x44BFB619
	...
	inline BOOL NETWORK_IS_IN_TUTORIAL_SESSION() { return invoke<BOOL>(0xADA24309FE08DACF); } // 0xADA24309FE08DACF 0x34DD7B28
	...
	inline void _NETWORK_SET_NETWORK_ID_HAS_PHYSICALITY(int netID, BOOL toggle) { invoke<Void>(0x2B1813ABA29016C5, netID, toggle); } // 0x2B1813ABA29016C5 0x155465EE
	...
	inline BOOL _NETWORK_HAVE_TUNABLES_BEEN_DOWNLOADED() { return invoke<BOOL>(0x0467C11ED88B7D28); } // 0x0467C11ED88B7D28
	...
	inline BOOL _NETWORK_DOES_TUNABLE_EXIST_HASH(Hash tunableContext, Hash tunableName) { return invoke<BOOL>(0xE4E53E1419D81127, tunableContext, tunableName); } // 0xE4E53E1419D81127
	...
	inline Any NETWORK_EXPLODE_VEHICLE(Vehicle vehicle, BOOL isAudible, BOOL isInvisible, Player player) { return invoke<Any>(0x301A42153C9AD707, vehicle, isAudible, isInvisible, player); } // 0x301A42153C9AD707 0x0E1B38AE
	...
	inline void _NETWORK_CACHE_LOCAL_PLAYER_HEAD_BLEND_DATA() { invoke<Void>(0xBD0BE0BFC927EAC1); } // 0xBD0BE0BFC927EAC1
	inline BOOL _0x237D5336A9A54108(Any p0) { return invoke<BOOL>(0x237D5336A9A54108, p0); } // 0x237D5336A9A54108
	inline BOOL _NETWORK_COPY_PED_BLEND_DATA(Ped ped, Player player) { return invoke<BOOL>(0x99B72C7ABDE5C910, ped, player); } // 0x99B72C7ABDE5C910
	...
	inline void _0x58C21165F6545892(const char* p0, const char* p1) { invoke<Void>(0x58C21165F6545892, p0, p1); } // 0x58C21165F6545892 0x365C50EE
	...
	inline Hash _0x3A3D5568AF297CD5(Hash p1) { return invoke<Hash>(0x3A3D5568AF297CD5, p1); } // 0x3A3D5568AF297CD5 0x9B9AFFF1
	inline void CLOUD_CHECK_AVAILABILITY() { invoke<Void>(0x4F18196C8D38768D); } // 0x4F18196C8D38768D 0xC38E9DB0
	...
	inline BOOL _0x158EC424F35EC469(const char* p0, BOOL p1, const char* contentType) { return invoke<BOOL>(0x158EC424F35EC469, p0, p1, contentType); } // 0x158EC424F35EC469 0xDED82A6E
	...
	inline BOOL _0x6D4CB481FAC835E8(Any p0, Any p1, const char* p2, Any p3) { return invoke<BOOL>(0x6D4CB481FAC835E8, p0, p1, p2, p3); } // 0x6D4CB481FAC835E8 0x40CF0783
	...
	inline BOOL _GET_CLAN_CONTENT(Any p0, Any p1, Any p2, Any* p3, Any* p4) { return invoke<BOOL>(0x9F6E2821885CAEE2, p0, p1, p2, p3, p4); } // 0x9F6E2821885CAEE2 0xA6D8B798
	...
	inline BOOL _0x97A770BEEF227E2B(Any p0, Any p1, Any* p2, Any* p3) { return invoke<BOOL>(0x97A770BEEF227E2B, p0, p1, p2, p3); } // 0x97A770BEEF227E2B 0x1CFB3F51
	...
	inline const char* GET_PLAYER_ADVANCED_MODIFIER_PRIVILEGES(int p0) { return invoke<const char*>(0xCD67AD041A394C9C, p0); } // 0xCD67AD041A394C9C 0x8F3137E6
	...
	inline Any _0xBAF6BABF9E7CCC13(int p0, Any* p1) { return invoke<Any>(0xBAF6BABF9E7CCC13, p0, p1); } // 0xBAF6BABF9E7CCC13 0x744A9EA5
	...
	inline BOOL _FACEBOOK_SET_HEIST_COMPLETE(const char* heistName, int cashEarned, int xpEarned) { return invoke<BOOL>(0x098AB65B9ED9A9EC, heistName, cashEarned, xpEarned); } // 0x098AB65B9ED9A9EC 0x30B51753
	inline BOOL _FACEBOOK_SET_CREATE_CHARACTER_COMPLETE() { return invoke<BOOL>(0xDC48473142545431); } // 0xDC48473142545431 0x02DAD93F
	inline BOOL _FACEBOOK_SET_MILESTONE_COMPLETE(int milestoneId) { return invoke<BOOL>(0x0AE1F1653B554AB9, milestoneId); } // 0x0AE1F1653B554AB9 0x2D947814
	inline BOOL _FACEBOOK_IS_SENDING_DATA() { return invoke<BOOL>(0x62B9FEC9A11F10EF); } // 0x62B9FEC9A11F10EF 0x37A28C26
	inline BOOL _FACEBOOK_DO_UNK_CHECK() { return invoke<BOOL>(0xA75E2B6733DA5142); } // 0xA75E2B6733DA5142 0x11E8B5CD
	inline BOOL _FACEBOOK_IS_AVAILABLE() { return invoke<BOOL>(0x43865688AE10F0D7); } // 0x43865688AE10F0D7 0x429AEAB3
	...
	inline BOOL _0x66B59CFFD78467AF() { return invoke<BOOL>(0x66B59CFFD78467AF); } // 0x66B59CFFD78467AF 0x0CA1167F
	inline BOOL _0x606E4D3E3CCCF3EB() { return invoke<BOOL>(0x606E4D3E3CCCF3EB); } // 0x606E4D3E3CCCF3EB 0x424C6E27
	...
	inline BOOL _0x422D396F80A96547() { return invoke<BOOL>(0x422D396F80A96547); } // 0x422D396F80A96547 0xC6EA802E
	inline BOOL NETWORK_HAS_ROS_PRIVILEGE(int index) { return invoke<BOOL>(0xA699957E60D80214, index); } // 0xA699957E60D80214 0xFD261E30
	inline BOOL _0xC22912B1D85F26B1(int p0, int* p1, Any* p2) { return invoke<BOOL>(0xC22912B1D85F26B1, p0, p1, p2); } // 0xC22912B1D85F26B1 0x8570DD34
	inline BOOL _0x593570C289A77688() { return invoke<BOOL>(0x593570C289A77688); } // 0x593570C289A77688
	...
	inline void _NETWORK_UPDATE_PLAYER_SCARS() { invoke<Void>(0xB7C7F6AD6424304B); } // 0xB7C7F6AD6424304B 0x371BBA08
...
{
	inline void NETWORK_INITIALIZE_CASH(Player p1, int p2) { invoke<Void>(0x3DA5ECD1A56CBA6D, p1, p2); } // 0x3DA5ECD1A56CBA6D 0x66DA9935
	inline void NETWORK_DELETE_CHARACTER(int const characterIndex, BOOL p1, BOOL p2) { invoke<Void>(0x05A50AF38947EB8D, characterIndex, p1, p2); } // 0x05A50AF38947EB8D 0xA9F7E9C3
	...
	inline BOOL NETWORK_CAN_SHARE_JOB_CASH() { return invoke<BOOL>(0x1C2473301B1C66BA); } // 0x1C2473301B1C66BA 0xA27B9FE8
	inline void NETWORK_REFUND_CASH(int m_Index, const char* szType, const char* szReason, BOOL bUnk) { invoke<Void>(0xF9C812CD7C46E817, m_Index, szType, szReason, bUnk); } // 0xF9C812CD7C46E817 0x07C92F21
	...
	inline void _NETWORK_EARN_FROM_BEND_JOB(int amount, const char* heistHash) { invoke<Void>(0x61326EE6DF15B0CA, amount, heistHash); } // 0x61326EE6DF15B0CA 0x5E81F55C
	...
	inline void _NETWORK_EARN_FROM_DAILY_OBJECTIVE(int p0, const char* p1, int p2) { invoke<Void>(0x6EA318C91C1A8786, p0, p1, p2); } // 0x6EA318C91C1A8786
	inline void _NETWORK_EARN_FROM_AMBIENT_JOB(int p0, const char* p1, Any* p2) { invoke<Void>(0xFB6DB092FBAE29E6, p0, p1, p2); } // 0xFB6DB092FBAE29E6
	inline void _NETWORK_EARN_FROM_JOB_BONUS(Any amont, Any* p1, Any* p2) { invoke<Void>(0x6816FB4416760775, amont, p1, p2); } // 0x6816FB4416760775
	...
	inline void NETWORK_SPENT_BULL_SHARK(int amount, BOOL p1, BOOL p2) { invoke<Void>(0xA6DD8458CE24012C, amount, p1, p2); } // 0xA6DD8458CE24012C 0xDE7D398C
	...
	inline BOOL _IS_CASH_GIFT_AVAILABLE() { return invoke<BOOL>(0x7C4FCCD2E4DEB394); } // 0x7C4FCCD2E4DEB394
	inline int NETWORK_GET_VC_BANK_BALANCE() { return invoke<int>(0x76EF28DA05EA395A); } // 0x76EF28DA05EA395A 0x16184FB5
	inline int NETWORK_GET_VC_WALLET_BALANCE(int const character) { return invoke<int>(0xA40F9C2623F6A8B5, character); } // 0xA40F9C2623F6A8B5 0x4F5B781C
	...
	inline BOOL _0xE154B48B68EF72BC(Any p0) { return invoke<BOOL>(0xE154B48B68EF72BC, p0); } // 0xE154B48B68EF72BC 0x531E4892
	inline BOOL _0x6FCF8DDEA146C45B(int p0) { return invoke<BOOL>(0x6FCF8DDEA146C45B, p0); } // 0x6FCF8DDEA146C45B 0xB96C7ABE
}

namespace DLC1
{
	inline int _GET_NUM_DECORATIONS(int const character) { return invoke<int>(0x278F76C3B0A8F109, character); } // 0x278F76C3B0A8F109 0x71D0CF3E
	inline BOOL _0xFF56381874F82086(int const character, int p1, int* outComponent) { return invoke<BOOL>(0xFF56381874F82086, character, p1, outComponent); } // 0xFF56381874F82086 0x2E9D628C
	...
	inline int _GET_NUM_PROPS_FROM_OUTFIT(int const character, int p1, int p2, BOOL p3, int p4, int componentId) { return invoke<int>(0x9BDF59818B1E38C1, character, p1, p2, p3, p4, componentId); } // 0x9BDF59818B1E38C1 0x594E862C
	...
	inline int _GET_VARIANTS_FOR_COMPONENT_COUNT(Hash componentHash) { return invoke<int>(0xC17AD0E5752BECDA, componentHash); } // 0xC17AD0E5752BECDA 0x159751B4
	...
	inline Any _GET_FORCED_COMPONENT(Any p0) { return invoke<Any>(0x017568A8182D98A6, p0); } // 0x017568A8182D98A6
	...
	inline BOOL _IS_TAG_RESTRICTED(Hash componentHash, Hash restrictionTag, int componentId) { return invoke<BOOL>(0x341DE7ED1D2A1BFD, componentHash, restrictionTag, componentId); } // 0x341DE7ED1D2A1BFD 0x8E2C7FD5
	inline int _GET_CHARACTER_OUTFITS_COUNT(int const character, BOOL p1) { return invoke<int>(0xF3FBE2D50A6A8C28, character, p1); } // 0xF3FBE2D50A6A8C28 0x1ECD23E7
	...
	inline BOOL GET_SHOP_PED_OUTFIT_PROP_VARIANT(Any outfitStruct, int slot, Any* propStruct) { return invoke<BOOL>(0xA9F9C2E0FDE11CBB, outfitStruct, slot, propStruct); } // 0xA9F9C2E0FDE11CBB 0x6641A864
	inline BOOL GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Any outfitStruct, int slot, Any* componentStruct) { return invoke<BOOL>(0x19F2A026EDF0013F, outfitStruct, slot, componentStruct); } // 0x19F2A026EDF0013F 0x818534AC
	...
	inline BOOL GET_DLC_WEAPON_COMPONENT_DATA(int dlcWeaponIndex, int dlcWeapCompIndex, Any* ComponentDataPtr) { return invoke<BOOL>(0x6CF598A2957C2BF8, dlcWeaponIndex, dlcWeapCompIndex, ComponentDataPtr); } // 0x6CF598A2957C2BF8 0x4B83FCAF
	inline BOOL _IS_DLC_DATA_EMPTY(Any* dlcData) { return invoke<BOOL>(0xD4D7B033C3AA243C, dlcData); } // 0xD4D7B033C3AA243C 0x06396058
	inline BOOL IS_DLC_VEHICLE_MOD(Any modData) { return invoke<BOOL>(0x0564B9FF9631B82C, modData); } // 0x0564B9FF9631B82C 0x35BCA844
...
namespace DLC2
{
	...
	inline BOOL _0x8D30F648014A92B5() { return invoke<BOOL>(0x8D30F648014A92B5); } // 0x8D30F648014A92B5 0xF69B729C
	...
	inline void _UNLOAD_MP_DLC_MAPS() { invoke<Void>(0xD7C10C4A637992C9); } // 0xD7C10C4A637992C9
...
namespace DECORATOR
{
	...
	inline BOOL _DECOR_SET_FLOAT(Entity entity, const char* propertyName, float value) { return invoke<BOOL>(0x211AB1DD8D0F363A, entity, propertyName, value); } // 0x211AB1DD8D0F363A
	...
	inline float _DECOR_GET_FLOAT(Entity entity, const char* propertyName) { return invoke<float>(0x6524A2F114706F43, entity, propertyName); } // 0x6524A2F114706F43
...
namespace SOCIALCLUB
{
	...
	inline BOOL _SC_INBOX_MESSAGE_GET_DATA_BOOL(int p0, const char* p1) { return invoke<BOOL>(0xFFE5C16F402D851D, p0, p1); } // 0xFFE5C16F402D851D
	...
	inline void _0xDA024BDBD600F44A(int* networkHandle) { invoke<Void>(0xDA024BDBD600F44A, networkHandle); } // 0xDA024BDBD600F44A 0x0B9A3512
	inline void _CREATE_PRESENCE_STAT_UPDATE(const char* p0) { invoke<Void>(0xA68D3D229F4F3B06, p0); } // 0xA68D3D229F4F3B06 0x75324674
	...
	inline BOOL _CREATE_PRESENCE_BOUNTY(const char* playerName) { return invoke<BOOL>(0x6AFD2CD753FEEF83, playerName); } // 0x6AFD2CD753FEEF83 0x628F489B
	...
	inline BOOL _0xBC1CC91205EC8D6E() { return invoke<BOOL>(0xBC1CC91205EC8D6E); } // 0xBC1CC91205EC8D6E 0x6C5738AB
	inline const char* _0xDF649C4E9AFDD788() { return invoke<const char*>(0xDF649C4E9AFDD788); } // 0xDF649C4E9AFDD788 0x468668F0
...
namespace UNK
{
	inline int _RETURN_ZERO() { return invoke<int>(0xF2CA003F167E21D2); } // 0xF2CA003F167E21D2 0x106C8317
	inline BOOL _RETURN_ZERO2() { return invoke<BOOL>(0xEF7D17BC6C85264C); } // 0xEF7D17BC6C85264C 0xD87F3A9E
...
namespace UNK1
{
	inline void _0x48621C9FCA3EBD28(int p0) { invoke<Void>(0x48621C9FCA3EBD28, p0); } // 0x48621C9FCA3EBD28
	...
	inline void _0x293220DA1B46CEBC(float p0, float p1, int p2) { invoke<Void>(0x293220DA1B46CEBC, p0, p1, p2); } // 0x293220DA1B46CEBC
...
namespace UNK2
{
	inline void _TOGGLE_PHONE_FILTER(const char* p0, BOOL p1) { invoke<Void>(0x7E2BD3EF6C205F09, p0, p1); } // 0x7E2BD3EF6C205F09
	inline BOOL _IS_INTERIOR_RENDERING_DISABLED() { return invoke<BOOL>(0x95AB8B5C992C7B58); } // 0x95AB8B5C992C7B58
	inline void _DISABLE_UNKNOWN_RENDERING() { invoke<Void>(0x5AD3932DAEB1E5D3); } // 0x5AD3932DAEB1E5D3
...
namespace UNK3
{
	inline int _NETWORK_SHOP_GET_PRICE(Hash itemHash, Hash categoryHash, int unused) { return invoke<int>(0xC27009422FCCA88D, itemHash, categoryHash, unused); } // 0xC27009422FCCA88D
	inline BOOL* _NET_GAMESERVER_CATALOG_IS_READY() { return invoke<BOOL*>(0x3C4487461E9B0DCB); } // 0x3C4487461E9B0DCB
	...
	inline BOOL _NETWORK_SHOP_BASKET_START(Any* p0, int p1, int p2, int p3) { return invoke<BOOL>(0x279F08B1A4B29B7E, p0, p1, p2, p3); } // 0x279F08B1A4B29B7E
	...
	inline BOOL _NETWORK_SHOP_BEGIN_SERVICE(int* transactionID, Hash categoryHash, Hash itemHash, Hash actionTypeHash, int ammount, int flags) { return invoke<BOOL>(0x3C5FD37B5499582E, transactionID, categoryHash, itemHash, actionTypeHash, ammount, flags); } // 0x3C5FD37B5499582E
	inline BOOL _NETWORK_SHOP_TERMINATE_SERVICE(int transactionID) { return invoke<BOOL>(0xE2A99A9B524BEFFF, transactionID); } // 0xE2A99A9B524BEFFF
	...
	inline BOOL _NETWORK_TRANSFER_BANK_TO_WALLET(int const charStatInt, int amount) { return invoke<BOOL>(0xD47A2C1BA117471D, charStatInt, amount); } // 0xD47A2C1BA117471D
	inline BOOL _NETWORK_TRANSFER_WALLET_TO_BANK(int const charStatInt, int amount) { return invoke<BOOL>(0xC2F7FE5309181C7D, charStatInt, amount); } // 0xC2F7FE5309181C7D
